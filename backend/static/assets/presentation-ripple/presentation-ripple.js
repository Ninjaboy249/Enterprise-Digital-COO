...
var H = class e {
	...
	*[Symbol.iterator]() {
...
}, he = /*@__PURE__*/ new U(), ge = /*@__PURE__*/ new me(), W = class e {
	static {
	...
	scale(e, t) {
		return re("Matrix3: .scale() is deprecated. Use .makeScale() instead."), this.premultiply(_e.makeScale(e, t)), this;
	}
	rotate(e) {
		return re("Matrix3: .rotate() is deprecated. Use .makeRotation() instead."), this.premultiply(_e.makeRotation(-e)), this;
	}
	translate(e, t) {
		return re("Matrix3: .translate() is deprecated. Use .makeTranslation() instead."), this.premultiply(_e.makeTranslation(e, t)), this;
	}
	makeTranslation(e, t) {
...
}, _e = /*@__PURE__*/ new W(), ve = /*@__PURE__*/ new W().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322), ye = /*@__PURE__*/ new W().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function be() {
	let e = {
		enabled: !0,
		workingColorSpace: k,
...
var Ce, we = class {
	static getDataURL(e, t = "image/png") {
		...
		if (e instanceof HTMLCanvasElement) n = e;
			...
			Ce === void 0 && (Ce = I("canvas")), Ce.width = e.width, Ce.height = e.height;
	...
	constructor(e = null) {
		this.isSource = !0, Object.defineProperty(this, "id", { value: Te++ }), this.uuid = le(), this.data = e, this.dataReady = !0, this.version = 0;
	}
	getSize(e) {
		let t = this.data;
...
var je = class e {
	...
	*[Symbol.iterator]() {
	...
	decompose(e, t, n) {
		...
		i < 0 && (a = -a), Le.copy(this);
		let c = 1 / a, l = 1 / o, u = 1 / s;
		return Le.elements[0] *= c, Le.elements[1] *= c, Le.elements[2] *= c, Le.elements[4] *= l, Le.elements[5] *= l, Le.elements[6] *= l, Le.elements[8] *= u, Le.elements[9] *= u, Le.elements[10] *= u, t.setFromRotationMatrix(Le), n.x = a, n.y = o, n.z = s, this;
	}
...
}, Ie = /*@__PURE__*/ new U(), Le = /*@__PURE__*/ new Fe(), q = /*@__PURE__*/ new U(0, 0, 0), Re = /*@__PURE__*/ new U(1, 1, 1), J = /*@__PURE__*/ new U(), Y = /*@__PURE__*/ new U(), ze = /*@__PURE__*/ new U(), Be = /*@__PURE__*/ new Fe(), Ve = /*@__PURE__*/ new me(), He = class e {
...
var Ue = class {
...
}, We = 0, Ge = /*@__PURE__*/ new U(), Ke = /*@__PURE__*/ new me(), qe = /*@__PURE__*/ new Fe(), Je = /*@__PURE__*/ new U(), Ye = /*@__PURE__*/ new U(), Xe = /*@__PURE__*/ new U(), Ze = /*@__PURE__*/ new me(), Qe = /*@__PURE__*/ new U(1, 0, 0), $e = /*@__PURE__*/ new U(0, 1, 0), et = /*@__PURE__*/ new U(0, 0, 1), tt = { type: "added" }, nt = { type: "removed" }, rt = {
	type: "childadded",
	child: null
}, it = {
	type: "childremoved",
	child: null
}, at = class e extends oe {
	constructor() {
		super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: We++ }), this.uuid = le(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = e.DEFAULT_UP.clone();
		let t = new U(), n = new He(), r = new me(), i = new U(1, 1, 1);
		function a() {
			r.setFromEuler(n, !1);
		}
		function o() {
	...
	add(e) {
		...
		return e === this ? (z("Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(tt), rt.child = e, this.dispatchEvent(rt), rt.child = null) : z("Object3D.add: object not an instance of THREE.Object3D.", e), this);
	}
	remove(e) {
		if (arguments.length > 1) {
...
at.DEFAULT_UP = /*@__PURE__*/ new U(0, 1, 0), at.DEFAULT_MATRIX_AUTO_UPDATE = !0, at.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0;
...
var X = class {
	...
	setHSL(e, t, n, r = G.workingColorSpace) {
		if (e = ue(e, 1), t = V(t, 0, 1), n = V(n, 0, 1), t === 0) this.r = this.g = this.b = n;
		else {
	...
	getHex(e = O) {
		return G.workingToColorSpace(pt.copy(this), e), Math.round(V(pt.r * 255, 0, 255)) * 65536 + Math.round(V(pt.g * 255, 0, 255)) * 256 + Math.round(V(pt.b * 255, 0, 255));
	}
	getHexString(e = O) {
		return ("000000" + this.getHex(e).toString(16)).slice(-6);
	}
	getHSL(e, t = G.workingColorSpace) {
		G.workingToColorSpace(pt.copy(this), t);
	...
	getRGB(e, t = G.workingColorSpace) {
		return G.workingToColorSpace(pt.copy(this), t), e.r = pt.r, e.g = pt.g, e.b = pt.b, e;
	}
	getStyle(e = O) {
		G.workingToColorSpace(pt.copy(this), e);
	...
	lerpHSL(e, t) {
		...
		let n = de(ut.h, dt.h, t), r = de(ut.s, dt.s, t), i = de(ut.l, dt.l, t);
...
var mt = class extends at {
...
}, ht = /*@__PURE__*/ new U(), gt = /*@__PURE__*/ new U(), _t = /*@__PURE__*/ new U(), vt = /*@__PURE__*/ new U(), yt = /*@__PURE__*/ new U(), bt = /*@__PURE__*/ new U(), xt = /*@__PURE__*/ new U(), St = /*@__PURE__*/ new U(), Ct = /*@__PURE__*/ new U(), wt = /*@__PURE__*/ new U(), Tt = /*@__PURE__*/ new je(), Et = /*@__PURE__*/ new je(), Dt = /*@__PURE__*/ new je(), Ot = class e {
	...
	/*@__PURE__*/ new U(),
	/*@__PURE__*/ new U()
], jt = /*@__PURE__*/ new U(), Mt = /*@__PURE__*/ new kt(), Nt = /*@__PURE__*/ new U(), Pt = /*@__PURE__*/ new U(), Ft = /*@__PURE__*/ new U(), It = /*@__PURE__*/ new U(), Lt = /*@__PURE__*/ new U(), Rt = /*@__PURE__*/ new U(), zt = /*@__PURE__*/ new U(), Bt = /*@__PURE__*/ new U(), Vt = /*@__PURE__*/ new U(), Ht = /*@__PURE__*/ new U();
...
var Wt = /*@__PURE__*/ new U(), Gt = /*@__PURE__*/ new H(), Kt = 0, qt = class extends oe {
	constructor(e, t, n = !1) {
...
}, Zt = /*@__PURE__*/ new kt(), Qt = /*@__PURE__*/ new U(), $t = /*@__PURE__*/ new U(), en = class {
...
}, tn = 0, nn = /*@__PURE__*/ new Fe(), rn = /*@__PURE__*/ new at(), an = /*@__PURE__*/ new U(), on = /*@__PURE__*/ new kt(), sn = /*@__PURE__*/ new kt(), cn = /*@__PURE__*/ new U(), ln = class e extends oe {
	constructor() {
		super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: tn++ }), this.uuid = le(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.indirectOffset = 0, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
			start: 0,
			count: Infinity
	...
	setIndex(e) {
		return Array.isArray(e) ? this.index = new (P(e) ? Yt : Jt)(e, 1) : this.index = e, this;
	}
	setIndirect(e, t = 0) {
...
}, un = 0, dn = class extends oe {
	constructor() {
		super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: un++ }), this.uuid = le(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new X(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = M, this.stencilZFail = M, this.stencilZPass = M, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
	}
	get alphaTest() {
...
}, fn = /*@__PURE__*/ new U(), pn = /*@__PURE__*/ new U(), mn = /*@__PURE__*/ new U(), hn = /*@__PURE__*/ new U(), gn = /*@__PURE__*/ new U(), _n = /*@__PURE__*/ new U(), vn = /*@__PURE__*/ new U(), yn = class {
...
}, xn = /*@__PURE__*/ new Fe(), Sn = /*@__PURE__*/ new yn(), Cn = /*@__PURE__*/ new en(), wn = /*@__PURE__*/ new U(), Tn = /*@__PURE__*/ new U(), En = /*@__PURE__*/ new U(), Dn = /*@__PURE__*/ new U(), On = /*@__PURE__*/ new U(), kn = /*@__PURE__*/ new U(), An = /*@__PURE__*/ new U(), jn = /*@__PURE__*/ new U(), Mn = class extends at {
...
function Pn(e, t, n, r, i, a, o, s, c, l) {
	...
	if (u) {
		let e = new U();
		Ot.getBarycoord(An, Tn, En, Dn, e), i && (u.uv = Ot.getInterpolatedAttribute(i, s, c, l, e, new H())), a && (u.uv1 = Ot.getInterpolatedAttribute(a, s, c, l, e, new H())), o && (u.normal = Ot.getInterpolatedAttribute(o, s, c, l, e, new U()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
		let t = {
			a: s,
			b: c,
			c: l,
...
var Fn = class extends Ae {
...
}, In = /*@__PURE__*/ new U(), Ln = /*@__PURE__*/ new U(), Rn = /*@__PURE__*/ new W(), zn = class {
	...
	setFromCoplanarPoints(e, t, n) {
		let r = In.subVectors(n, t).cross(Ln.subVectors(e, t)).normalize();
	...
	intersectLine(e, t, n = !0) {
		let r = e.delta(In), i = this.normal.dot(r);
	...
	applyMatrix4(e, t) {
		let n = t || Rn.getNormalMatrix(e), r = this.coplanarPoint(In).applyMatrix4(e), i = this.normal.applyMatrix3(n).normalize();
...
}, Bn = /*@__PURE__*/ new en(), Vn = /*@__PURE__*/ new H(.5, .5), Hn = /*@__PURE__*/ new U(), Un = class {
	constructor(e = new zn(), t = new zn(), n = new zn(), r = new zn(), i = new zn(), a = new zn()) {
		this.planes = [
			e,
			t,
			n,
	...
	intersectsSprite(e) {
		return Bn.center.set(0, 0, 0), Bn.radius = .7071067811865476 + Vn.distanceTo(e.center), Bn.applyMatrix4(e.matrixWorld), this.intersectsSphere(Bn);
	}
	intersectsSphere(e) {
	...
	intersectsBox(e) {
		...
		for (let n = 0; n < 6; n++) {
			let r = t[n];
			if (Hn.x = r.normal.x > 0 ? e.max.x : e.min.x, Hn.y = r.normal.y > 0 ? e.max.y : e.min.y, Hn.z = r.normal.z > 0 ? e.max.z : e.min.z, r.distanceToPoint(Hn) < 0) return !1;
		}
		return !0;
	}
	containsPoint(e) {
...
function Xn(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (Qn(i)) i.isRenderTargetTexture ? (R("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
			else if (Array.isArray(i)) if (Qn(i[0])) {
				let e = [];
...
var lr = class {
	...
	constructor(e, t, n, r) {
		...
		this.name = e, this.times = cr(t, this.TimeBufferType), this.values = cr(n, this.ValueBufferType), this.setInterpolation(r || this.DefaultInterpolation);
	}
	static toJSON(e) {
	...
	InterpolantFactoryMethodBezier(e) {
		let t = new pr(this.times, this.values, this.getValueSize(), e);
...
hr.prototype.ValueTypeName = "bool", hr.prototype.ValueBufferType = Array, hr.prototype.DefaultInterpolation = x, hr.prototype.InterpolantFactoryMethodLinear = void 0, hr.prototype.InterpolantFactoryMethodSmooth = void 0;
var gr = class extends mr {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
};
gr.prototype.ValueTypeName = "color";
...
yr.prototype.ValueTypeName = "quaternion", yr.prototype.InterpolantFactoryMethodSmooth = void 0;
var br = class extends mr {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
br.prototype.ValueTypeName = "string", br.prototype.ValueBufferType = Array, br.prototype.DefaultInterpolation = x, br.prototype.InterpolantFactoryMethodLinear = void 0, br.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var Sr = {
	...
	files: {},
	add: function(e, t) {
		this.enabled !== !1 && (Cr(e) || (this.files[e] = t));
	},
	get: function(e) {
		if (this.enabled !== !1 && !Cr(e)) return this.files[e];
	},
	remove: function(e) {
		delete this.files[e];
	},
...
var wr = /*@__PURE__*/ new class {
	...
	constructor(e) {
		this.manager = e === void 0 ? wr : e, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {}, typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", { detail: this }));
	}
	load() {}
	loadAsync(e, t) {
		let n = this;
...
var Er = /* @__PURE__ */ new WeakMap(), Dr = class extends Tr {
	constructor(e) {
		super(e);
	}
	load(e, t, n, r) {
		this.path !== void 0 && (e = this.path + e), e = this.manager.resolveURL(e);
		let i = this, a = Sr.get(`image:${e}`);
		if (a !== void 0) {
		...
		function s() {
			...
			Er.delete(this), i.manager.itemEnd(e);
		}
		function c(t) {
			l(), r && r(t), Sr.remove(`image:${e}`);
			let n = Er.get(this) || [];
			for (let e = 0; e < n.length; e++) {
				let r = n[e];
				r.onError && r.onError(t);
			}
			Er.delete(this), i.manager.itemError(e), i.manager.itemEnd(e);
		}
		function l() {
			o.removeEventListener("load", s, !1), o.removeEventListener("error", c, !1);
		}
		return o.addEventListener("load", s, !1), o.addEventListener("error", c, !1), e.slice(0, 5) !== "data:" && this.crossOrigin !== void 0 && (o.crossOrigin = this.crossOrigin), Sr.add(`image:${e}`, o), i.manager.itemStart(e), o.src = e, o;
	}
}, Or = class extends Tr {
	constructor(e) {
		super(e);
	...
	load(e, t, n, r) {
		let i = new Ae(), a = new Dr(this.manager);
		return a.setCrossOrigin(this.crossOrigin), a.setPath(this.path), a.load(e, function(e) {
			i.image = e, i.needsUpdate = !0, t !== void 0 && t(i);
		}, n, r), i;
	}
}, kr = /*@__PURE__*/ new U(), Ar = /*@__PURE__*/ new me(), jr = /*@__PURE__*/ new U(), Mr = class extends at {
	constructor() {
		super(), this.isCamera = !0, this.type = "Camera", this.matrixWorldInverse = new Fe(), this.projectionMatrix = new Fe(), this.projectionMatrixInverse = new Fe(), this.coordinateSystem = N, this._reversedDepth = !1;
	}
	get reversedDepth() {
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(kr, Ar, jr), jr.x === 1 && jr.y === 1 && jr.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(kr, Ar, jr.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t, n = !1) {
		super.updateWorldMatrix(e, t, n), this.matrixWorld.decompose(kr, Ar, jr), jr.x === 1 && jr.y === 1 && jr.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(kr, Ar, jr.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, Nr = /*@__PURE__*/ new U(), Pr = /*@__PURE__*/ new H(), Fr = /*@__PURE__*/ new H(), Ir = class extends Mr {
	...
	setFocalLength(e) {
		...
		this.fov = ce * 2 * Math.atan(t), this.updateProjectionMatrix();
	}
	getFocalLength() {
		let e = Math.tan(se * .5 * this.fov);
		return .5 * this.getFilmHeight() / e;
	}
	getEffectiveFOV() {
		return ce * 2 * Math.atan(Math.tan(se * .5 * this.fov) / this.zoom);
	}
	getFilmWidth() {
	...
	getViewBounds(e, t, n) {
		Nr.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse), t.set(Nr.x, Nr.y).multiplyScalar(-e / Nr.z), Nr.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse), n.set(Nr.x, Nr.y).multiplyScalar(-e / Nr.z);
	}
	getViewSize(e, t) {
		return this.getViewBounds(e, Pr, Fr), t.subVectors(Fr, Pr);
	}
	...
	updateProjectionMatrix() {
		let e = this.near, t = e * Math.tan(se * .5 * this.fov) / this.zoom, n = 2 * t, r = this.aspect * n, i = -.5 * r, a = this.view;
...
}, Rr = -90, zr = 1, Br = class extends at {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new Ir(Rr, zr, e, t);
		r.layers = this.layers, this.add(r);
		let i = new Ir(Rr, zr, e, t);
		i.layers = this.layers, this.add(i);
		let a = new Ir(Rr, zr, e, t);
		a.layers = this.layers, this.add(a);
		let o = new Ir(Rr, zr, e, t);
		o.layers = this.layers, this.add(o);
		let s = new Ir(Rr, zr, e, t);
		s.layers = this.layers, this.add(s);
		let c = new Ir(Rr, zr, e, t);
...
}, Hr = "\\[\\]\\.:\\/", Ur = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), Wr = "[^\\[\\]\\.:\\/]", Gr = "[^" + Hr.replace("\\.", "") + "]", Kr = /*@__PURE__*/ "((?:WC+[\\/:])*)".replace("WC", Wr), qr = /*@__PURE__*/ "(WCOD+)?".replace("WCOD", Gr), Jr = /*@__PURE__*/ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", Wr), Yr = /*@__PURE__*/ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", Wr), Xr = RegExp("^" + Kr + qr + Jr + Yr + "$"), Zr = [
	"material",
	"materials",
	"bones",
	"map"
	...
	static sanitizeNodeName(e) {
		return e.replace(/\s/g, "_").replace(Ur, "");
	}
	static parseTrackName(e) {
		...
		if (r !== void 0 && r !== -1) {
			...
			Zr.indexOf(e) !== -1 && (n.nodeName = n.nodeName.substring(0, r), n.objectName = e);
		}
...
$r.Composite = Qr, $r.prototype.BindingType = {
	Direct: 0,
	EntireArray: 1,
	ArrayElement: 2,
	HasFromToArray: 3
}, $r.prototype.Versioning = {
	None: 0,
	NeedsUpdate: 1,
	MatrixWorldNeedsUpdate: 2
}, $r.prototype.GetterByBindingType = [
	$r.prototype._getValue_direct,
	$r.prototype._getValue_array,
	$r.prototype._getValue_arrayElement,
	$r.prototype._getValue_toArray
], $r.prototype.SetterByBindingTypeAndVersioning = [
	[
		$r.prototype._setValue_direct,
		$r.prototype._setValue_direct_setNeedsUpdate,
		$r.prototype._setValue_direct_setMatrixWorldNeedsUpdate
	],
	[
		$r.prototype._setValue_array,
		$r.prototype._setValue_array_setNeedsUpdate,
		$r.prototype._setValue_array_setMatrixWorldNeedsUpdate
	],
	[
		$r.prototype._setValue_arrayElement,
		$r.prototype._setValue_arrayElement_setNeedsUpdate,
		$r.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate
	],
	[
		$r.prototype._setValue_fromArray,
		$r.prototype._setValue_fromArray_setNeedsUpdate,
		$r.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate
	]
], class e {
	static {
...
var Z = {
	...
	points: {
		uniforms: /*@__PURE__*/ Zn([Q.points, Q.fog]),
	...
	depth: {
		uniforms: /*@__PURE__*/ Zn([Q.common, Q.displacementmap]),
	...
	sprite: {
		uniforms: /*@__PURE__*/ Zn([Q.sprite, Q.fog]),
...
ii.physical = {
	uniforms: /*@__PURE__*/ Zn([ii.standard.uniforms, {
		clearcoat: { value: 0 },
...
var ai = {
	...
	b: 0,
	g: 0
}, oi = /*@__PURE__*/ new Fe(), si = /*@__PURE__*/ new W();
...
function ci(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new Mn(new Jn(1, 1, 1), new ir({
			name: "BackgroundCubeMaterial",
			uniforms: Xn(ii.backgroundCube.uniforms),
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(oi.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(si), l.material.toneMapped = G.getTransfer(i.colorSpace) !== j, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new Mn(new Yn(2, 2), new ir({
			name: "BackgroundMaterial",
			uniforms: Xn(ii.background.uniforms),
	...
	function g(t, r) {
		t.getRGB(ai, er(e)), n.buffers.color.setClear(ai.r, ai.g, ai.b, r, a);
	}
	function _() {
...
function fi(e) {
	let t = this, n = null, r = 0, i = !1, a = !1, o = new zn(), s = new W(), c = {
		value: null,
		needsUpdate: !1
	};
...
var pi = 4, mi = [
	...
	.526,
	.582
], hi = 20, gi = 256, _i = /*@__PURE__*/ new Lr(), vi = /*@__PURE__*/ new X(), yi = null, bi = 0, xi = 0, Si = !1, Ci = /*@__PURE__*/ new U(), wi = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = Ci } = i;
		yi = this._renderer.getRenderTarget(), bi = this._renderer.getActiveCubeFace(), xi = this._renderer.getActiveMipmapLevel(), Si = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	compileCubemapShader() {
		this._cubemapMaterial === null && (this._cubemapMaterial = ji(), this._compileMaterial(this._cubemapMaterial));
	}
	compileEquirectangularShader() {
		this._equirectMaterial === null && (this._equirectMaterial = Ai(), this._compileMaterial(this._equirectMaterial));
	}
	dispose() {
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(yi, bi, xi), this._renderer.xr.enabled = Si, e.scissorTest = !1, Di(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), yi = this._renderer.getRenderTarget(), bi = this._renderer.getActiveCubeFace(), xi = this._renderer.getActiveMipmapLevel(), Si = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			this._pingPongRenderTarget !== null && this._dispose(), this._pingPongRenderTarget = Ei(e, t, n);
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = Ti(r)), this._blurMaterial = ki(r, e, t), this._ggxMaterial = Oi(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
		let t = new Mn(new ln(), e);
		this._renderer.compile(t, _i);
	}
	_sceneToCubeUV(e, t, n, r, i) {
		let a = new Ir(90, 1, t, n), o = [
			1,
			-1,
			1,
			1,
		...
		c.getClearColor(vi), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Mn(new Jn(), new bn({
		...
		m ? m.isColor && (f.color.copy(m), e.background = null, p = !0) : (f.color.copy(vi), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
			...
			Di(r, n * l, t > 2 ? l : 0, l, l), c.setRenderTarget(r), p && c.render(d, a), c.render(e, a);
		}
		c.toneMapping = u, c.autoClear = l, e.background = m;
	}
	_textureToCubeUV(e, t) {
		let n = this._renderer, r = e.mapping === 301 || e.mapping === 302;
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = ji()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = Ai());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		Di(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, _i);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - pi ? n - d + pi : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, Di(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, _i), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, Di(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, _i);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / (2 * hi - 1), p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : hi;
		m > hi && R(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${hi}`);
		let h = [], g = 0;
		for (let e = 0; e < hi; ++e) {
		...
		Di(t, 3 * v * (r > _ - pi ? r - _ + pi : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, _i);
	}
};
function Ti(e) {
	let t = [], n = [], r = [], i = e, a = e - pi + 1 + mi.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		t.push(a);
		let s = 1 / a;
		o > e - pi ? s = mi[o - e + pi - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new ln();
		h.setAttribute("position", new qt(f, 3)), h.setAttribute("uv", new qt(p, 2)), h.setAttribute("faceIndex", new qt(m, 1)), r.push(new Mn(h, null)), i > pi && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
function ki(e, t, n) {
	let r = new Float32Array(hi), i = new U(0, 1, 0);
	return new ir({
...
var Ni = class extends Ne {
	constructor(e = 1, t = {}) {
		...
		this.texture = new Wn(r), this._setTextureOptions(t), this.texture.isRenderTargetTexture = !0;
	}
	fromEquirectangularTexture(e, t) {
		...
		return t.minFilter === 1008 && (t.minFilter = i), new Br(1, 10, this).update(e, o), t.minFilter = s, o.geometry.dispose(), o.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
	...
	function o(t) {
		if (t && t.isTexture) {
			...
			if (a || o) {
				...
				if (t.isRenderTargetTexture && t.pmremVersion !== s) return r === null && (r = new wi(e)), i = a ? r.fromEquirectangular(t, i) : r.fromCubemap(t, i), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), i.texture;
				if (i !== void 0) return i.texture;
				{
					let s = t.image;
					return a && s && s.height > 0 || o && s && c(s) ? (r === null && (r = new wi(e)), i = a ? r.fromEquirectangular(t) : r.fromCubemap(t), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), t.addEventListener("dispose", u), i.texture) : null;
				}
			}
		}
		return t;
...
function Hi(e, t, n, r, i, a) {
	let o = new Ne(t, n, {
		...
		stencilBuffer: a,
		samples: r ? 4 : 0,
		depthTexture: i ? new Gn(t, n) : void 0
	}), s = new Ne(t, n, {
		type: u,
		depthBuffer: !1,
		stencilBuffer: !1
	...
	let l = new ar({
		...
		depthTest: !1,
		depthWrite: !1
	}), d = new Mn(c, l), f = new Lr(-1, 1, 1, -1, 0, 1), p = null, m = null, h = !1, g, _ = null, v = [], y = !1;
	this.setSize = function(e, t) {
		...
		if (p !== e.outputColorSpace || m !== e.toneMapping) {
			p = e.outputColorSpace, m = e.toneMapping, l.defines = {}, G.getTransfer(p) === "srgb" && (l.defines.SRGB_TRANSFER = "");
			let t = Vi[m];
...
var Ui = /*@__PURE__*/ new Ae(), Wi = /*@__PURE__*/ new Gn(1, 1), Gi = /*@__PURE__*/ new K(), Ki = /*@__PURE__*/ new Pe(), qi = /*@__PURE__*/ new Wn(), Ji = [], Yi = [], Xi = /* @__PURE__ */ new Float32Array(16), Zi = /* @__PURE__ */ new Float32Array(9), Qi = /* @__PURE__ */ new Float32Array(4);
function $i(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = Ji[i];
	if (a === void 0 && (a = new Float32Array(i), Ji[i] = a), t !== 0) {
		r.toArray(a, 0);
...
function na(e, t) {
	let n = Yi[t];
	n === void 0 && (n = new Int32Array(t), Yi[t] = n);
...
function sa(e, t) {
	...
	if (r === void 0) {
		...
		if (ea(n, r)) return;
		Qi.set(r), e.uniformMatrix2fv(this.addr, !1, Qi), ta(n, r);
	}
}
function ca(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (ea(n, r)) return;
		Zi.set(r), e.uniformMatrix3fv(this.addr, !1, Zi), ta(n, r);
	}
}
function la(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (ea(n, r)) return;
		Xi.set(r), e.uniformMatrix4fv(this.addr, !1, Xi), ta(n, r);
	}
}
function ua(e, t) {
	let n = this.cache;
...
function va(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (Wi.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = Wi) : a = Ui, n.setTexture2D(t || a, i);
}
function ya(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture3D(t || Ki, i);
}
function ba(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
...
function xa(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || Gi, i);
}
function Sa(e) {
	switch (e) {
		case 5126: return ra;
...
function wa(e, t) {
	let n = $i(t, this.size, 2);
	e.uniform2fv(this.addr, n);
}
function Ta(e, t) {
	let n = $i(t, this.size, 3);
	e.uniform3fv(this.addr, n);
}
function Ea(e, t) {
	let n = $i(t, this.size, 4);
...
function Oa(e, t) {
	let n = $i(t, this.size, 9);
	e.uniformMatrix3fv(this.addr, !1, n);
}
function ka(e, t) {
	let n = $i(t, this.size, 16);
...
function Ra(e, t, n) {
	let r = this.cache, i = t.length, a = na(n, i);
	ea(r, a) || (e.uniform1iv(this.addr, a), ta(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? Wi : Ui;
	for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || o, a[e]);
}
function za(e, t, n) {
	let r = this.cache, i = t.length, a = na(n, i);
	ea(r, a) || (e.uniform1iv(this.addr, a), ta(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || Ki, a[e]);
}
function Ba(e, t, n) {
	let r = this.cache, i = t.length, a = na(n, i);
	ea(r, a) || (e.uniform1iv(this.addr, a), ta(r, a));
...
function Va(e, t, n) {
	let r = this.cache, i = t.length, a = na(n, i);
	ea(r, a) || (e.uniform1iv(this.addr, a), ta(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || Gi, a[e]);
}
function Ha(e) {
	switch (e) {
		case 5126: return Ca;
		case 35664: return wa;
		case 35665: return Ta;
		case 35666: return Ea;
		case 35674: return Da;
		case 35675: return Oa;
		case 35676: return ka;
		case 5124:
		case 35670: return Aa;
		case 35667:
		case 35671: return ja;
		case 35668:
		case 35672: return Ma;
		case 35669:
		case 35673: return Na;
		case 5125: return Pa;
		case 36294: return Fa;
		case 36295: return Ia;
		case 36296: return La;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
		case 35682: return Ra;
		case 35679:
		case 36299:
...
var Ua = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.setValue = Sa(t.type);
	}
}, Wa = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = Ha(t.type);
	}
}, Ga = class {
	constructor(e) {
...
function Ja(e, t, n) {
	...
	for (Ka.lastIndex = 0;;) {
		let a = Ka.exec(r), o = Ka.lastIndex, s = a[1], c = a[2] === "]", l = a[3];
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			qa(n, l === void 0 ? new Ua(s, e, t) : new Wa(s, e, t));
			break;
		} else {
			let e = n.map[s];
			e === void 0 && (e = new Ga(s), qa(n, e)), n = e;
		}
	}
}
var Ya = class {
	constructor(e, t) {
		...
		for (let r = 0; r < n; ++r) {
			...
			Ja(n, e.getUniformLocation(t, n.name), this);
		}
		let r = [], i = [];
...
var eo = /*@__PURE__*/ new W();
function to(e) {
	G._getMatrix(eo, G.workingColorSpace, e);
	let t = `mat3( ${eo.elements.map((e) => e.toFixed(4))} )`;
...
var oo = /*@__PURE__*/ new U();
function so() {
	return G.getLuminanceCoefficients(oo), [
		"float luminance( const in vec3 rgb ) {",
		`	const vec3 weights = vec3( ${oo.x.toFixed(4)}, ${oo.y.toFixed(4)}, ${oo.z.toFixed(4)} );`,
		"	return dot( weights, rgb );",
		"}"
	].join("\n");
}
function co(e) {
	return [e.extensionClipCullDistance ? "#extension GL_ANGLE_clip_cull_distance : require" : "", e.extensionMultiDraw ? "#extension GL_ANGLE_multi_draw : require" : ""].filter(fo).join("\n");
}
function lo(e) {
	let t = [];
	for (let n in e) {
...
var ho = /^[ \t]*#include +<([\w\d./]+)>/gm;
function go(e) {
	return e.replace(ho, vo);
}
...
var yo = /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;
function bo(e) {
	return e.replace(yo, xo);
}
function xo(e, t, n, r) {
	let i = "";
...
function wo(e) {
	return Co[e.shadowMapType] || "SHADOWMAP_TYPE_BASIC";
}
var To = {
...
function Eo(e) {
	return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : To[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
var Do = { 302: "ENVMAP_MODE_REFRACTION" };
function Oo(e) {
	return e.envMap === !1 ? "ENVMAP_MODE_REFLECTION" : Do[e.envMapMode] || "ENVMAP_MODE_REFLECTION";
}
var ko = {
...
function Ao(e) {
	return e.envMap === !1 ? "ENVMAP_BLENDING_NONE" : ko[e.combine] || "ENVMAP_BLENDING_NONE";
}
function jo(e) {
...
function Mo(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = wo(n), l = Eo(n), u = Oo(n), d = Ao(n), f = jo(n), p = co(n), m = lo(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	n.isRawShaderMaterial ? (g = [
		...
		n.toneMapping === 0 ? "" : ao("toneMapping", n.toneMapping),
	...
	let y = v + g + o, b = v + _ + s, x = Xa(i, i.VERTEX_SHADER, y), S = Xa(i, i.FRAGMENT_SHADER, b);
	...
	function C(t) {
		if (e.debug.checkShaderErrors) {
			...
			if (i.getProgramParameter(h, i.LINK_STATUS) === !1) if (l = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(i, h, x, S);
				...
				let e = no(i, x, "vertex"), n = no(i, S, "fragment");
		...
		i.deleteShader(x), i.deleteShader(S), w = new Ya(i, h), T = uo(i, h);
	}
	let w;
	...
	return this.isReady = function() {
		return E === !1 && (E = i.getProgramParameter(h, Za)), E;
	}, this.destroy = function() {
		r.releaseStatesOfProgram(this), i.deleteProgram(h), this.program = void 0;
	}, this.type = n.shaderType, this.name = n.shaderName, this.id = Qa++, this.cacheKey = t, this.usedTimes = 1, this.program = h, this.vertexShader = x, this.fragmentShader = S, this;
}
var No = 0, Po = class {
	constructor() {
	...
	_getShaderStage(e) {
		...
		return n === void 0 && (n = new Fo(e), t.set(e, n)), n;
	}
}, Fo = class {
	constructor(e) {
		this.id = No++, this.code = e, this.usedTimes = 0;
	}
};
function Io(e) {
...
function Lo(e, t, n, r, i, a) {
	let o = new Ue(), s = new Po(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let De = {
			...
			packedNormalMap: z && i.normalMapType === 0 && Io(i.normalMap.format),
			metalnessMap: ae,
			roughnessMap: oe,
			anisotropy: B,
			anisotropyMap: de,
			...
			specularMapUv: W && m(i.specularMap.channel),
			...
			toneMapping: Ee,
			decodeVideoTexture: F && i.map.isVideoTexture === !0 && G.getTransfer(i.map.colorSpace) === "srgb",
			decodeVideoTextureEmissive: ie && i.emissiveMap.isVideoTexture === !0 && G.getTransfer(i.emissiveMap.colorSpace) === "srgb",
	...
	function b(t, n) {
		let r = u.get(n);
		return r === void 0 ? (r = new Mo(e, n, t, i), l.push(r), u.set(n, r)) : ++r.usedTimes, r;
	}
	function x(e) {
		if (--e.usedTimes === 0) {
			let t = l.indexOf(e);
...
function Vo() {
	...
	function u(e, t, a) {
		n.length > 1 && n.sort(e || zo), r.length > 1 && r.sort(t || Bo), i.length > 1 && i.sort(t || Bo), a && (n.reverse(), r.reverse(), i.reverse());
	}
	function d() {
...
function Ho() {
	...
	function t(t, n) {
		let r = e.get(t), i;
		return r === void 0 ? (i = new Vo(), e.set(t, [i])) : n >= r.length ? (i = new Vo(), r.push(i)) : i = r[n], i;
	}
	function n() {
		e = /* @__PURE__ */ new WeakMap();
	}
...
function Yo(e) {
	...
	function n(n, r = 0) {
		let i = t.get(n), a;
		return i === void 0 ? (a = new Jo(e), t.set(n, [a])) : r >= i.length ? (a = new Jo(e), i.push(a)) : a = i[r], a;
	}
	function r() {
...
var Xo = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", Zo = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", Qo = [
	...
	/*@__PURE__*/ new U(0, -1, 0),
	/*@__PURE__*/ new U(0, -1, 0)
], es = /*@__PURE__*/ new Fe(), ts = /*@__PURE__*/ new U(), ns = /*@__PURE__*/ new U();
function rs(e, t, n) {
	let a = new Un(), o = new H(), s = new H(), d = new je(), f = new or(), p = new sr(), m = {}, g = n.maxTextureSize, _ = {
		0: 1,
		1: 0,
		2: 2
	}, y = new ir({
			...
			if (_.camera._reversedDepth = S, _.map === null || b === !0) {
				if (_.map !== null && (_.map.depthTexture !== null && (_.map.depthTexture.dispose(), _.map.depthTexture = null), _.map.dispose()), this.type === 3) {
					...
					_.map = new Ne(o.x, o.y, {
						...
						magFilter: i,
						generateMipmaps: !1
					}), _.map.texture.name = m.name + ".shadowMap", _.map.depthTexture = new Gn(o.x, o.y, l), _.map.depthTexture.name = m.name + ".shadowMapDepth", _.map.depthTexture.format = h, _.map.depthTexture.compareFunction = null, _.map.depthTexture.minFilter = r, _.map.depthTexture.magFilter = r;
				} else m.isPointLight ? (_.map = new Ni(o.x), _.map.depthTexture = new Kn(o.x, c)) : (_.map = new Ne(o.x, o.y), _.map.depthTexture = new Gn(o.x, o.y, c)), _.map.depthTexture.name = m.name + ".shadowMap", _.map.depthTexture.format = h, this.type === 1 ? (_.map.depthTexture.compareFunction = S ? 518 : 515, _.map.depthTexture.minFilter = i, _.map.depthTexture.magFilter = i) : (_.map.depthTexture.compareFunction = null, _.map.depthTexture.minFilter = r, _.map.depthTexture.magFilter = r);
	...
	function T(n, r) {
		let i = t.update(S);
		y.defines.VSM_SAMPLES !== n.blurSamples && (y.defines.VSM_SAMPLES = n.blurSamples, b.defines.VSM_SAMPLES = n.blurSamples, y.needsUpdate = !0, b.needsUpdate = !0), n.mapPass === null && (n.mapPass = new Ne(o.x, o.y, {
			format: v,
			type: u
...
function is(e, t) {
	...
	let a = new n(), o = new r(), s = new i(), c = /* @__PURE__ */ new WeakMap(), l = /* @__PURE__ */ new WeakMap(), u = {}, d = {}, f = {}, p = /* @__PURE__ */ new WeakMap(), m = [], h = null, g = !1, _ = null, v = null, y = null, b = null, x = null, S = null, C = null, w = new X(0, 0, 0), T = 0, E = !1, D = null, O = null, k = null, A = null, j = null, M = e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS), N = !1, P = 0, F = e.getParameter(e.VERSION);
	F.indexOf("WebGL") === -1 ? F.indexOf("OpenGL ES") !== -1 && (P = parseFloat(/^OpenGL ES (\d)/.exec(F)[1]), N = P >= 2) : (P = parseFloat(/^WebGL (\d)/.exec(F)[1]), N = P >= 1);
	let I = null, ee = {}, te = e.getParameter(e.SCISSOR_BOX), ne = e.getParameter(e.VIEWPORT), L = new je().fromArray(te), R = new je().fromArray(ne);
	function re(t, n, r, i) {
	...
	function de(t, n, r, i, a, o, s, c, l, u) {
		...
		a ||= n, o ||= r, s ||= i, (n !== v || a !== x) && (e.blendEquationSeparate(V[n], V[a]), v = n, x = a), (r !== y || i !== b || o !== S || s !== C) && (e.blendFuncSeparate(ue[r], ue[i], ue[o], ue[s]), y = r, b = i, S = o, C = s), (c.equals(w) === !1 || l !== T) && (e.blendColor(c.r, c.g, c.b, l), w.copy(c), T = l), _ = t, E = !1;
	}
	function fe(t, n) {
		...
		s.setTest(i), i && (s.setMask(t.stencilWriteMask), s.setFunc(t.stencilFunc, t.stencilRef, t.stencilFuncMask), s.setOp(t.stencilFail, t.stencilZFail, t.stencilZPass)), U(t.polygonOffset, t.polygonOffsetFactor, t.polygonOffsetUnits), t.alphaToCoverage === !0 ? oe(e.SAMPLE_ALPHA_TO_COVERAGE) : B(e.SAMPLE_ALPHA_TO_COVERAGE);
	}
	function pe(t) {
	...
	function K() {
		e.disable(e.BLEND), e.disable(e.CULL_FACE), e.disable(e.DEPTH_TEST), e.disable(e.POLYGON_OFFSET_FILL), e.disable(e.SCISSOR_TEST), e.disable(e.STENCIL_TEST), e.disable(e.SAMPLE_ALPHA_TO_COVERAGE), e.blendEquation(e.FUNC_ADD), e.blendFunc(e.ONE, e.ZERO), e.blendFuncSeparate(e.ONE, e.ZERO, e.ONE, e.ZERO), e.blendColor(0, 0, 0, 0), e.colorMask(!0, !0, !0, !0), e.clearColor(0, 0, 0, 0), e.depthMask(!0), e.depthFunc(e.LESS), o.setReversed(!1), e.clearDepth(1), e.stencilMask(4294967295), e.stencilFunc(e.ALWAYS, 0, 4294967295), e.stencilOp(e.KEEP, e.KEEP, e.KEEP), e.clearStencil(0), e.cullFace(e.BACK), e.frontFace(e.CCW), e.polygonOffset(0, 0), e.activeTexture(e.TEXTURE0), e.bindFramebuffer(e.FRAMEBUFFER, null), e.bindFramebuffer(e.DRAW_FRAMEBUFFER, null), e.bindFramebuffer(e.READ_FRAMEBUFFER, null), e.useProgram(null), e.lineWidth(1), e.scissor(0, 0, e.canvas.width, e.canvas.height), e.viewport(0, 0, e.canvas.width, e.canvas.height), e.pixelStorei(e.PACK_ALIGNMENT, 4), e.pixelStorei(e.UNPACK_ALIGNMENT, 4), e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, !1), e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !1), e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL, e.BROWSER_DEFAULT_WEBGL), e.pixelStorei(e.PACK_ROW_LENGTH, 0), e.pixelStorei(e.PACK_SKIP_PIXELS, 0), e.pixelStorei(e.PACK_SKIP_ROWS, 0), e.pixelStorei(e.UNPACK_ROW_LENGTH, 0), e.pixelStorei(e.UNPACK_IMAGE_HEIGHT, 0), e.pixelStorei(e.UNPACK_SKIP_PIXELS, 0), e.pixelStorei(e.UNPACK_SKIP_ROWS, 0), e.pixelStorei(e.UNPACK_SKIP_IMAGES, 0), u = {}, d = {}, I = null, ee = {}, f = {}, p = /* @__PURE__ */ new WeakMap(), m = [], h = null, g = !1, _ = null, v = null, y = null, b = null, x = null, S = null, C = null, w = new X(0, 0, 0), T = 0, E = !1, D = null, O = null, k = null, A = null, j = null, L.set(0, 0, e.canvas.width, e.canvas.height), R.set(0, 0, e.canvas.width, e.canvas.height), a.reset(), o.reset(), s.reset();
	}
	return {
		buffers: {
			color: a,
...
function as(o, s, c, l, u, d, f) {
			...
			if (t.isDepthTexture) p = O(t.format === g, t.type), y && (_ ? c.texStorage2D(o.TEXTURE_2D, 1, p, e.width, e.height) : c.texImage2D(o.TEXTURE_2D, 0, p, e.width, e.height, 0, l, f, null));
				...
				for (let n = 0, r = h.length; n < r; n++) if (m = h[n], t.format !== 1023) if (l !== null) if (_) {
					if (b) if (t.layerUpdates.size > 0) {
						let e = ei(m.width, m.height, t.format, t.type);
				...
				if (y && c.texStorage3D(o.TEXTURE_2D_ARRAY, x, p, e.width, e.height, e.depth), b) if (t.layerUpdates.size > 0) {
					let n = ei(e.width, e.height, t.format, t.type);
					for (let r of t.layerUpdates) {
	...
	function _e(e) {
		...
		if (e.depthTexture && !t.__autoAllocateDepthBuffer) if (n) for (let n = 0; n < 6; n++) W(t.__webglFramebuffer[n], e, n);
		else {
			let n = e.texture.mipmaps;
			n && n.length > 0 ? W(t.__webglFramebuffer[0], e, 0) : W(t.__webglFramebuffer, e, 0);
		}
		else if (n) {
		...
		if (e.samples > 0) {
			if (Te(e) === !1) {
				...
				for (let c = 0; c < t.length; c++) {
					...
					o.blitFramebuffer(0, 0, n, r, 0, 0, n, r, i, o.NEAREST), m === !0 && (xe.length = 0, Se.length = 0, xe.push(o.COLOR_ATTACHMENT0 + c), e.depthBuffer && e.resolveDepthBuffer === !1 && (xe.push(a), Se.push(a), o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER, Se)), o.invalidateFramebuffer(o.READ_FRAMEBUFFER, xe));
				}
...
var ss = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", cs = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", ls = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			...
			this.mesh = new Mn(new Yn(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, s = "local-floor", l = 1, u = null, d = null, f = null, _ = null, v = null, y = null, b = typeof XRWebGLBinding < "u", x = new ls(), S = {}, C = t.getContextAttributes(), w = null, T = null, E = [], D = [], O = new H(), k = null, A = new Ir();
		A.viewport = new je();
		let j = new Ir();
		j.viewport = new je();
		let M = [A, j], N = new Vr(), P = null, F = null;
			...
			if (r = d, r !== null) {
				if (w = e.getRenderTarget(), r.addEventListener("select", I), r.addEventListener("selectstart", I), r.addEventListener("selectend", I), r.addEventListener("squeeze", I), r.addEventListener("squeezestart", I), r.addEventListener("squeezeend", I), r.addEventListener("end", ee), r.addEventListener("inputsourceschange", te), C.xrCompatible !== !0 && await t.makeXRCompatible(), k = e.getPixelRatio(), e.getSize(O), b && "createProjectionLayer" in XRWebGLBinding.prototype) {
					...
					f = this.getBinding(), _ = f.createProjectionLayer(l), r.updateRenderState({ layers: [_] }), e.setPixelRatio(1), e.setSize(_.textureWidth, _.textureHeight, !1), T = new Ne(_.textureWidth, _.textureHeight, {
						format: m,
						type: o,
						depthTexture: new Gn(_.textureWidth, _.textureHeight, a, void 0, void 0, void 0, void 0, void 0, void 0, n),
...
}, ds = /*@__PURE__*/ new Fe(), fs = /*@__PURE__*/ new W();
fs.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function ps(e, t) {
	function n(e, t) {
	...
	function a(e, r) {
		...
		a && (e.envMap.value = a, e.envMapRotation.value.setFromMatrix4(ds.makeRotationFromEuler(o)).transpose(), a.isCubeTexture && a.isRenderTargetTexture === !1 && e.envMapRotation.value.premultiply(fs), e.reflectivity.value = r.reflectivity, e.ior.value = r.ior, e.refractionRatio.value = r.refractionRatio), r.lightMap && (e.lightMap.value = r.lightMap, e.lightMapIntensity.value = r.lightMapIntensity, n(r.lightMap, e.lightMapTransform)), r.aoMap && (e.aoMap.value = r.aoMap, e.aoMapIntensity.value = r.aoMapIntensity, n(r.aoMap, e.aoMapTransform));
	}
	function o(e, t) {
...
function _s() {
	return gs === null && (gs = new Fn(hs, 16, 16, v, u), gs.name = "DFG_LUT", gs.minFilter = i, gs.magFilter = i, gs.wrapS = t, gs.wrapT = t, gs.generateMipmaps = !1, gs.needsUpdate = !0), gs;
}
var vs = class {
	constructor(e = {}) {
		...
		let T = C, E = /* @__PURE__ */ new Set([
			...
			d,
			f
		]), k = /* @__PURE__ */ new Uint32Array(4), A = /* @__PURE__ */ new Int32Array(4), j = new U(), M = null, P = null, F = [], I = [], te = null;
		...
		let ce = 0, le = 0, V = null, ue = -1, de = null, fe = new je(), pe = new je(), H = null, me = new X(0), he = 0, ge = t.width, W = t.height, _e = 1, ve = null, ye = null, be = new je(0, 0, ge, W), xe = new je(0, 0, ge, W), Se = !1, Ce = new Un(), we = !1, Te = !1, Ee = new Fe(), De = new U(), Oe = new je(), ke = {
			background: null,
			fog: null,
			environment: null,
		...
		try {
			...
			if ("setAttribute" in t && t.setAttribute("data-engine", "three.js r185"), t.addEventListener("webglcontextlost", it, !1), t.addEventListener("webglcontextrestored", at, !1), t.addEventListener("webglcontextcreationerror", ot, !1), K === null) {
				let t = "webgl2";
				if (K = Pe(t, e), K === null) throw Pe(t) ? Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.") : Error("THREE.WebGLRenderer: Error creating WebGL context.");
			}
		} catch (e) {
			throw z("WebGLRenderer: " + e.message), e;
		}
		let Ie, Le, q, Re, J, Y, ze, Be, Ve, He, Ue, We, Ge, Ke, qe, Je, Ye, Xe, Ze, Qe, $e, et, tt;
		function nt() {
			Ie = new Fi(K), Ie.init(), $e = new os(K, Ie), Le = new di(K, Ie, e, $e), q = new is(K, Ie), Le.reversedDepthBuffer && S && q.buffers.depth.setReversed(!0), oe = K.createFramebuffer(), B = K.createFramebuffer(), se = K.createFramebuffer(), Re = new Ri(K), J = new Ro(), Y = new as(K, Ie, q, J, Le, $e, Re), ze = new Pi(L), Be = new ri(K), et = new li(K, Be), Ve = new Ii(K, Be, Re, et), He = new Bi(K, Ve, Be, et, Re), Xe = new zi(K, Le, Y), qe = new fi(J), Ue = new Lo(L, ze, Ie, Le, et, qe), We = new ps(L, J), Ge = new Ho(), Ke = new Yo(Ie), Ye = new ci(L, ze, q, He, w, h), Je = new rs(L, He, Le), tt = new ms(K, Re, Le, q), Ze = new ui(K, Ie, Re), Qe = new Li(K, Ie, Re), Re.programs = Ue.programs, L.capabilities = Le, L.extensions = Ie, L.properties = J, L.renderLists = Ge, L.shadowMap = Je, L.state = q, L.info = Re;
		}
		nt(), T !== 1009 && (te = new Hi(T, t.width, t.height, m, r, i));
		let rt = new us(L, K);
		this.xr = rt, this.getContext = function() {
			...
			e !== void 0 && (_e = e, this.setSize(ge, W, !1));
			...
			ge = e, W = n, t.width = Math.floor(e * _e), t.height = Math.floor(n * _e), r === !0 && (t.style.width = e + "px", t.style.height = n + "px"), te !== null && te.setSize(t.width, t.height), this.setViewport(0, 0, e, n);
		}, this.getDrawingBufferSize = function(e) {
			return e.set(ge * _e, W * _e).floor();
		}, this.setDrawingBufferSize = function(e, n, r) {
			ge = e, W = n, _e = r, t.width = Math.floor(e * r), t.height = Math.floor(n * r), this.setViewport(0, 0, e, n);
		}, this.setEffects = function(e) {
			if (T === 1009) {
			...
			e.isVector4 ? be.set(e.x, e.y, e.z, e.w) : be.set(e, t, n, r), q.viewport(fe.copy(be).multiplyScalar(_e).round());
		}, this.getScissor = function(e) {
			return e.copy(xe);
		}, this.setScissor = function(e, t, n, r) {
			e.isVector4 ? xe.set(e.x, e.y, e.z, e.w) : xe.set(e, t, n, r), q.scissor(pe.copy(xe).multiplyScalar(_e).round());
			...
			if (e) {
				...
				if (e) {
					let e = V.texture.type, t = D.has(e), n = Ye.getClearColor(), r = Ye.getClearAlpha(), i = n.r, a = n.g, o = n.b;
					t ? (k[0] = i, k[1] = a, k[2] = o, k[3] = r, K.clearBufferuiv(K.COLOR, 0, k)) : (A[0] = i, A[1] = a, A[2] = o, A[3] = r, K.clearBufferiv(K.COLOR, 0, A));
		...
		this.renderBufferDirect = function(e, t, n, r, i, a) {
			...
			et.setup(i, r, s, n, c);
			let h, g = Ze;
			if (c !== null && (h = Be.get(c), g = Qe, g.setIndex(h)), i.isMesh) r.wireframe === !0 ? (q.setLineWidth(r.wireframeLinewidth * Me()), g.setMode(K.LINES)) : g.setMode(K.TRIANGLES);
			else if (i.isLine) {
				let e = r.linewidth;
				e === void 0 && (e = 1), q.setLineWidth(e * Me()), i.isLineSegments ? g.setMode(K.LINES) : i.isLineLoop ? g.setMode(K.LINE_LOOP) : g.setMode(K.LINE_STRIP);
		...
		this.compile = function(e, t, n = null) {
			n === null && (n = e), P = Ke.get(n), P.init(t), I.push(P), n.traverseVisible(function(e) {
		...
		ht.setAnimationLoop(ft), typeof self < "u" && ht.setContext(self), this.setAnimationLoop = function(e) {
			dt = e, rt.setAnimationLoop(e), e === null ? ht.stop() : ht.start();
		}, rt.addEventListener("sessionstart", pt), rt.addEventListener("sessionend", mt), this.render = function(e, t) {
			...
			let n = rt.enabled === !0 && rt.isPresenting === !0, r = te !== null && (V === null || n) && te.begin(L, V);
			if (e.matrixWorldAutoUpdate === !0 && e.updateMatrixWorld(), t.parent === null && t.matrixWorldAutoUpdate === !0 && t.updateMatrixWorld(), rt.enabled === !0 && rt.isPresenting === !0 && (te === null || te.isCompositing() === !1) && (rt.cameraAutoUpdate === !0 && rt.updateCamera(t), t = rt.getCamera()), e.isScene === !0 && e.onBeforeRender(L, e, t, V), P = Ke.get(e, I.length), P.init(t), P.state.textureUnits = Y.getTextureUnits(), I.push(P), Ee.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), Ce.setFromProjectionMatrix(Ee, N, t.reversedDepth), Te = this.localClippingEnabled, we = qe.init(this.clippingPlanes, Te), M = Ge.get(e, F.length), M.init(), F.push(M), rt.enabled === !0 && rt.isPresenting === !0) {
				let e = L.xr.getDepthSensingMesh();
				e !== null && gt(e, t, -Infinity, L.sortObjects);
			}
			gt(e, t, 0, L.sortObjects), M.finish(), L.sortObjects === !0 && M.sort(ve, ye, t.reversedDepth), Ae = rt.enabled === !1 || rt.isPresenting === !1 || rt.hasDepthSensing() === !1, Ae && Ye.addToRenderList(M, e), this.info.render.frame++, this.info.autoReset === !0 && this.info.reset(), we === !0 && qe.beginShadows();
			let i = P.state.shadowsArray;
			if (Je.render(i, e, t), we === !0 && qe.endShadows(), (r && te.hasRenderPass()) === !1) {
				...
				} else r.length > 0 && vt(n, r, e, t), Ae && Ye.render(e), _t(M, e, t);
			}
			...
			if (e.layers.test(t.layers)) {
				if (e.isGroup) n = e.renderOrder;
					...
					if (!e.frustumCulled || Ce.intersectsSprite(e)) {
						...
						i.visible && M.push(e, t, i, n, Oe.z, null);
					}
					...
					if (r && (e.boundingSphere === void 0 ? (t.boundingSphere === null && t.computeBoundingSphere(), Oe.copy(t.boundingSphere.center)) : (e.boundingSphere === null && e.computeBoundingSphere(), Oe.copy(e.boundingSphere.center)), Oe.applyMatrix4(e.matrixWorld).applyMatrix4(Ee)), Array.isArray(i)) {
						...
						for (let a = 0, o = r.length; a < o; a++) {
							...
							s && s.visible && M.push(e, t, s, n, Oe.z, o);
						}
					} else i.visible && M.push(e, t, i, n, Oe.z, null);
				}
			}
			let i = e.children;
		...
		function _t(e, t, n, r) {
			...
			P.setupLightsView(n), we === !0 && qe.setGlobalState(L.clippingPlanes, n), r && q.viewport(fe.copy(r)), i.length > 0 && yt(i, t, n), a.length > 0 && yt(a, t, n), o.length > 0 && yt(o, t, n), q.buffers.depth.setTest(!0), q.buffers.depth.setMask(!0), q.buffers.color.setMask(!0), q.setPolygonOffset(!1);
		}
		function vt(e, t, n, r) {
			...
			if (P.state.transmissionRenderTarget[r.id] === void 0) {
				...
				P.state.transmissionRenderTarget[r.id] = new Ne(1, 1, {
					generateMipmaps: !0,
					type: e ? u : o,
					minFilter: a,
			...
			let s = P.state.transmissionRenderTarget[r.id], c = r.viewport || fe;
			...
			L.setRenderTarget(s), L.getClearColor(me), he = L.getClearAlpha(), he < 1 && L.setClearColor(16777215, .5), L.clear(), Ae && Ye.render(n);
			let p = L.toneMapping;
			L.toneMapping = 0;
			let m = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), P.setupLightsView(r), we === !0 && qe.setGlobalState(L.clippingPlanes, r), yt(e, n, r), Y.updateMultisampleRenderTarget(s), Y.updateRenderTargetMipmap(s), Ie.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
		...
		function xt(e, t, n) {
			t.isScene !== !0 && (t = ke);
			let r = J.get(e), i = P.state.lights, a = P.state.shadowsArray, o = i.state.version, s = Ue.getParameters(e, i.state, a, t, n, P.state.lightProbeGridArray), c = Ue.getProgramCacheKey(s), l = r.programs;
		...
		function Tt(e, t, n, r, i) {
			...
			let a = t.fog, o = r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial ? t.environment : null, s = V === null ? L.outputColorSpace : V.isXRRenderTarget === !0 ? V.texture.colorSpace : G.workingColorSpace, c = r.isMeshStandardMaterial || r.isMeshLambertMaterial && !r.envMap || r.isMeshPhongMaterial && !r.envMap, l = ze.get(r.envMap || o, c), u = r.vertexColors === !0 && !!n.attributes.color && n.attributes.color.itemSize === 4, d = !!n.attributes.tangent && (!!r.normalMap || r.anisotropy > 0), f = !!n.morphAttributes.position, p = !!n.morphAttributes.normal, m = !!n.morphAttributes.color, h = 0;
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Xe.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(K, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = _s()), C) {
				if (T.setValue(K, "toneMappingExposure", L.toneMappingExposure), v.needsLights && Et(E, w), a && r.fog === !0 && We.refreshFogUniforms(E, a), We.refreshMaterialUniforms(E, r, _e, W, P.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
				...
				Ya.upload(K, St(v), E, Y);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (Ya.upload(K, St(v), E, Y), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(K, "center", i.center), T.setValue(K, "modelViewMatrix", i.modelViewMatrix), T.setValue(K, "normalMatrix", i.normalMatrix), T.setValue(K, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
		...
		this.getActiveCubeFace = function() {
			...
			if (e) {
				...
				if (o.__useDefaultFramebuffer !== void 0) {
					q.bindFramebuffer(K.FRAMEBUFFER, o.__webglFramebuffer), fe.copy(e.viewport), pe.copy(e.scissor), H = e.scissorTest, q.viewport(fe), q.scissor(pe), q.setScissorTest(H), ue = -1;
					return;
				...
				e.isWebGLCubeRenderTarget ? (r = Array.isArray(c[t]) ? c[t][n] : c[t], i = !0) : r = e.samples > 0 && Y.useMultisampledRTT(e) === !1 ? J.get(e).__webglMultisampledFramebuffer : Array.isArray(c) ? c[n] : c, fe.copy(e.viewport), pe.copy(e.scissor), H = e.scissorTest;
			} else fe.copy(be).multiplyScalar(_e).floor(), pe.copy(xe).multiplyScalar(_e).floor(), H = Se;
			if (n !== 0 && (r = oe), q.bindFramebuffer(K.FRAMEBUFFER, r) && q.drawBuffers(e, r), q.viewport(fe), q.scissor(pe), q.setScissorTest(H), i) {
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				...
				try {
					...
					if (e.textures.length > 1 && K.readBuffer(K.COLOR_ATTACHMENT0 + s), !Le.textureFormatReadable(c)) {
					...
					t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i && K.readPixels(t, n, r, i, $e.convert(c), $e.convert(l), a);
				} finally {
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
				...
				if (e.textures.length > 1 && K.readBuffer(K.COLOR_ATTACHMENT0 + s), !Le.textureFormatReadable(l)) throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");
				...
				K.bindBuffer(K.PIXEL_PACK_BUFFER, d), K.bufferData(K.PIXEL_PACK_BUFFER, a.byteLength, K.STREAM_READ), K.readPixels(t, n, r, i, $e.convert(l), $e.convert(u), 0);
				...
				return K.flush(), await ie(K, p, 4), K.bindBuffer(K.PIXEL_PACK_BUFFER, d), K.getBufferSubData(K.PIXEL_PACK_BUFFER, 0, a), K.deleteBuffer(d), K.deleteSync(p), a;
			...
			if (e.isDepthTexture) {
				...
				q.bindFramebuffer(K.READ_FRAMEBUFFER, B), q.bindFramebuffer(K.DRAW_FRAMEBUFFER, se);
			...
			ce = 0, le = 0, V = null, q.reset(), et.reset();
...
var xs = {
	...
	overwrite: !1,
	delay: 0
}, Cs, ws, Ts, Es = 1e8, Ds = 1 / Es, Os = Math.PI * 2, ks = Os / 4, As = 0, js = Math.sqrt, Ms = Math.cos, Ns = Math.sin, Ps = function(e) {
	...
	return Fs(e) || Ps(e);
}, Hs = typeof ArrayBuffer == "function" && ArrayBuffer.isView || function() {}, Us = Array.isArray, Ws = /random\([^)]+\)/g, Gs = /,\s*/g, Ks = /(?:-?\.?\d|\.)+/gi, qs = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Js = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Ys = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Xs = /[+-]=-?[.\d]+/, Zs = /[^,'"\[\]\s]+/gi, Qs = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, $s, ec, tc, nc, rc = {}, ic = {}, ac, oc = function(e) {
	return (ic = Rc(e, rc)) && nd;
}, sc = function(e, t) {
	return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()");
}, cc = function(e, t) {
	return !t && console.warn(e);
}, lc = function(e, t) {
	return e && (rc[e] = t) && ic && (ic[e] = t) || rc;
}, uc = function() {
	return 0;
}, dc = {
	suppressEvents: !0,
	...
	suppressEvents: !0,
	kill: !1
}, pc = { suppressEvents: !0 }, mc = {}, hc = [], gc = {}, _c, vc = {}, yc = {}, bc = 30, xc = [], Sc = "", Cc = function(e) {
	var t = e[0], n, r;
	if (Rs(t) || Fs(t) || (e = [e]), !(n = (t._gsap || {}).harness)) {
		for (r = xc.length; r-- && !xc[r].targetTest(t););
		n = xc[r];
	}
	for (r = e.length; r--;) e[r] && (e[r]._gsap || (e[r]._gsap = new fu(e[r], n))) || e.splice(r, 1);
	return e;
}, wc = function(e) {
	return e._gsap || Cc(xl(e))[0]._gsap;
}, Tc = function(e, t, n) {
	return (n = e[t]) && Fs(n) ? e[t]() : Ls(n) && e.getAttribute && e.getAttribute(t) || n;
}, Ec = function(e, t) {
	...
	var e = hc.length, t = hc.slice(0), n, r;
	for (gc = {}, hc.length = 0, n = 0; n < e; n++) r = t[n], r && r._lazy && (r.render(r._lazy[0], r._lazy[1], !0)._lazy = 0);
}, Mc = function(e) {
	return !!(e._initted || e._startAt || e.add);
}, Nc = function(e, t, n, r) {
	hc.length && !ws && jc(), e.render(t, n, r || !!(ws && t < 0 && Mc(e))), hc.length && !ws && jc();
}, Pc = function(e) {
	var t = parseFloat(e);
	return (t || t === 0) && (e + "").match(Zs).length < 2 ? t : Ps(e) ? e.trim() : e;
}, Fc = function(e) {
	return e;
}, Ic = function(e, t) {
	...
	for (var r in n) r !== "__proto__" && r !== "constructor" && r !== "prototype" && (t[r] = Rs(n[r]) ? e(t[r] || (t[r] = {}), n[r]) : n[r]);
	return t;
}, Bc = function(e, t) {
	var n = {}, r;
	...
	var t = e.parent || $s, n = e.keyframes ? Lc(Us(e.keyframes)) : Ic;
	if (zs(e.inherit)) for (; t;) n(e, t.vars.defaults), t = t.parent || t._dp;
	return e;
}, Hc = function(e, t) {
	...
	return e._startAt && (ws ? e._startAt.revert(fc) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, r));
}, Yc = function e(t) {
	return !t || t._ts && e(t.parent);
}, Xc = function(e) {
	return e._repeat ? Zc(e._tTime, e = e.duration() + e._rDelay) * e : 0;
}, Zc = function(e, t) {
	var n = Math.floor(e = Oc(e / t));
	return e && n === e ? n - 1 : n;
}, Qc = function(e, t) {
	return (e - t._start) * t._ts + (t._ts >= 0 ? 0 : t._dirty ? t.totalDuration() : t._tDur);
}, $c = function(e) {
	return e._end = Oc(e._start + (e._tDur / Math.abs(e._ts || e._rts || Ds) || 0));
}, el = function(e, t) {
	var n = e._dp;
	return n && n.smoothChildTiming && e._ts && (e._start = Oc(n._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), $c(e), n._dirty || Kc(n, e)), e;
}, tl = function(e, t) {
	var n;
	if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (n = Qc(e.rawTime(), t), (!t._dur || hl(0, t.totalDuration(), n) - t._tTime > Ds) && t.render(n, !0)), Kc(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
		if (e._dur < e.duration()) for (n = e; n._dp;) n.rawTime() >= 0 && n.totalTime(n._tTime), n = n._dp;
		e._zTime = -Ds;
	}
}, nl = function(e, t, n, r) {
	return t.parent && Gc(t), t._start = Oc((Is(n) ? n : n || e !== $s ? fl(e, n, t) : e._time) + t._delay), t._end = Oc(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Uc(e, t, "_first", "_last", e._sort ? "_start" : 0), ol(t) || (e._recent = t), r || tl(e, t), e._ts < 0 && el(e, e._tTime), e;
}, rl = function(e, t) {
	return (rc.ScrollTrigger || sc("scrollTrigger", t)) && rc.ScrollTrigger.create(t, e);
}, il = function(e, t, n, r, i) {
	if (xu(e, t, i), !e._initted) return 1;
	if (!n && e._pt && !ws && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && _c !== $l.frame) return hc.push(e), e._lazy = [i, r], 1;
}, al = function e(t) {
	var n = t.parent;
	...
	var i = e.ratio, a = t < 0 || !t && (!e._start && al(e) && !(!e._initted && ol(e)) || (e._ts < 0 || e._dp._ts < 0) && !ol(e)) ? 0 : 1, o = e._rDelay, s = 0, c, l, u;
	if (o && e._repeat && (s = hl(0, e._tDur, t), l = Zc(s, o), e._yoyo && l & 1 && (a = 1 - a), l !== Zc(e._tTime, o) && (i = 1 - a, e.vars.repeatRefresh && e._initted && e.invalidate())), a !== i || ws || r || e._zTime === Ds || !t && e._zTime) {
		if (!e._initted && il(e, t, r, n, s)) return;
		for (u = e._zTime, e._zTime = t || (n ? Ds : 0), n ||= t && !u, e.ratio = a, e._from && (a = 1 - a), e._time = 0, e._tTime = s, c = e._pt; c;) c.r(a, c.d), c = c._next;
		t < 0 && Jc(e, t, n, !0), e._onUpdate && !n && Rl(e, "onUpdate"), s && e._repeat && !n && e.parent && Rl(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === a && (a && Gc(e, 1), !n && !ws && (Rl(e, a ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
	} else e._zTime ||= t;
}, cl = function(e, t, n) {
	var r;
	...
	var i = e._repeat, a = Oc(t) || 0, o = e._tTime / e._tDur;
	return o && !r && (e._time *= a / e._dur), e._dur = a, e._tDur = i ? i < 0 ? 1e10 : Oc(a * (i + 1) + e._rDelay * i) : a, o > 0 && !r && el(e, e._tTime = e._tDur * o), e.parent && $c(e), n || Kc(e.parent, e), e;
}, ul = function(e) {
	return e instanceof mu ? Kc(e) : ll(e, e._dur);
}, dl = {
	_start: 0,
	endTime: uc,
	totalDuration: uc
}, fl = function e(t, n, r) {
	var i = t.labels, a = t._recent || dl, o = t.duration() >= Es ? a.endTime(!1) : t._dur, s, c, l;
	return Ps(n) && (isNaN(n) || n in i) ? (c = n.charAt(0), l = n.substr(-1) === "%", s = n.indexOf("="), c === "<" || c === ">" ? (s >= 0 && (n = n.replace(/=/, "")), (c === "<" ? a._start : a.endTime(a._repeat >= 0)) + (parseFloat(n.substr(1)) || 0) * (l ? (s < 0 ? a : r).totalDuration() / 100 : 1)) : s < 0 ? (n in i || (i[n] = o), i[n]) : (c = parseFloat(n.charAt(s - 1) + n.substr(s + 1)), l && r && (c = c / 100 * (Us(r) ? r[0] : r).totalDuration()), s > 1 ? e(t, n.substr(0, s - 1), r) + c : o + c)) : n == null ? o : +n;
}, pl = function(e, t, n) {
	var r = Is(t[1]), i = (r ? 2 : 1) + (e < 2 ? 0 : 1), a = t[i], o, s;
	if (r && (a.duration = t[1]), a.parent = n, e) {
		for (o = a, s = n; s && !("immediateRender" in o);) o = s.vars.defaults || {}, s = zs(s.vars.inherit) && s.parent;
		a.immediateRender = zs(o.immediateRender), e < 2 ? a.runBackwards = 1 : a.startAt = t[i - 1];
	}
	return new Ou(t[0], a, t[i + 1]);
}, ml = function(e, t) {
	return e || e === 0 ? t(e) : t;
}, hl = function(e, t, n) {
	return n < e ? e : n > t ? t : n;
}, gl = function(e, t) {
	return !Ps(e) || !(t = Qs.exec(e)) ? "" : t[1];
}, _l = function(e, t, n) {
	return ml(n, function(n) {
		return hl(e, t, n);
	});
}, vl = [].slice, yl = function(e, t) {
	return e && Rs(e) && "length" in e && (!t && !e.length || e.length - 1 in e && Rs(e[0])) && !e.nodeType && e !== ec;
}, bl = function(e, t, n) {
	return n === void 0 && (n = []), e.forEach(function(e) {
		var r;
		return Ps(e) && !t || yl(e, 1) ? (r = n).push.apply(r, xl(e)) : n.push(e);
	}) || n;
}, xl = function(e, t, n) {
	return Ts && !t && Ts.selector ? Ts.selector(e) : Ps(e) && !n && (tc || !eu()) ? vl.call((t || nc).querySelectorAll(e), 0) : Us(e) ? bl(e, n) : yl(e) ? vl.call(e, 0) : e ? [e] : [];
}, Sl = function(e) {
	return e = xl(e)[0] || cc("Invalid scope") || {}, function(t) {
		var n = e.current || e.nativeElement || e;
		return xl(t, n.querySelectorAll ? n : n === e ? cc("Invalid scope") || nc.createElement("div") : e);
	};
}, Cl = function(e) {
	...
	if (Fs(e)) return e;
	var t = Rs(e) ? e : { each: e }, n = su(t.ease), r = t.from || 0, i = parseFloat(t.base) || 0, a = {}, o = r > 0 && r < 1, s = isNaN(r) || o, c = t.axis, l = r, u = r;
	return Ps(r) ? l = u = {
		center: .5,
		edges: .5,
		end: 1
		...
		if (!p) {
			if (S = t.grid === "auto" ? 0 : (t.grid || [1, Es])[1], !S) {
				for (b = -Es; b < (b = d[S++].getBoundingClientRect().left) && S < f;);
				S < f && S--;
			}
			for (p = a[f] = [], m = s ? Math.min(S, f) * l - .5 : r % S, h = S === Es ? 0 : s ? f * u / S - .5 : r / S | 0, b = 0, x = Es, y = 0; y < f; y++) g = y % S - m, _ = h - (y / S | 0), p[y] = v = c ? Math.abs(c === "y" ? _ : g) : js(g * g + _ * _), v > b && (b = v), v < x && (x = v);
			r === "random" && Cl(p), p.max = b - x, p.min = x, p.v = f = (parseFloat(t.amount) || parseFloat(t.each) * (S > f ? f - 1 : c ? c === "y" ? f / S : S : Math.max(S, f / S)) || 0) * (r === "edges" ? -1 : 1), p.b = f < 0 ? i - f : i, p.u = gl(t.amount || t.each) || 0, n = n && f < 0 ? ou(n) : n;
		}
		return f = (p[e] - p.min) / p.max || 0, Oc(p.b + (n ? n(f) : f) * p.v) + p.u;
	};
}, Tl = function(e) {
	var t = 10 ** ((e + "").split(".")[1] || "").length;
	return function(n) {
		var r = Oc(Math.round(parseFloat(n) / e) * e * t);
		return (r - r % 1) / t + (Is(n) ? 0 : gl(n));
	};
}, El = function(e, t) {
	var n = Us(e), r, i;
	return !n && Rs(e) && (r = n = e.radius || Es, e.values ? (e = xl(e.values), (i = !Is(e[0])) && (r *= r)) : e = Tl(e.increment)), ml(t, n ? Fs(e) ? function(t) {
		return i = e(t), Math.abs(i - t) <= r ? i : t;
	} : function(t) {
		for (var n = parseFloat(i ? t.x : t), a = parseFloat(i ? t.y : 0), o = Es, s = 0, c = e.length, l, u; c--;) i ? (l = e[c].x - n, u = e[c].y - a, l = l * l + u * u) : l = Math.abs(e[c] - n), l < o && (o = l, s = c);
		return s = !r || o <= r ? e[s] : t, i || s === t || Is(t) ? s : s + gl(t);
	} : Tl(e));
}, Dl = function(e, t, n, r) {
	return ml(Us(e) ? !t : n === !0 ? !!(n = 0) : !r, function() {
		return Us(e) ? e[~~(Math.random() * e.length)] : (n ||= 1e-5) && (r = n < 1 ? 10 ** ((n + "").length - 2) : 1) && Math.floor(Math.round((e - n / 2 + Math.random() * (t - e + n * .99)) / n) * n * r) / r;
	});
}, Ol = function() {
	var e = [...arguments];
	return function(t) {
	...
	var i = n - t;
	return Us(t) ? jl(t, e(0, t.length), n) : ml(r, function(e) {
		return (i + (e - t) % i) % i + t;
	});
}, Nl = function e(t, n, r) {
	var i = n - t, a = i * 2;
	return Us(t) ? jl(t, e(0, t.length - 1), n) : ml(r, function(e) {
		return e = (a + (e - t) % a) % a || 0, t + (e > i ? a - e : e);
	});
}, Pl = function(e) {
	return e.replace(Ws, function(e) {
		var t = e.indexOf("[") + 1, n = e.substring(t || 7, t ? e.indexOf("]") : e.length - 1).split(Gs);
		return Dl(t ? n : +n[0], t ? 0 : +n[1], +n[2] || 1e-5);
	});
	...
	if (!a) {
		...
		if (!u) {
			for (c in n) gu.call(s, t, c, "get", n[c]);
			a = function(e) {
				return Lu(e, s) || (o ? t.p : t);
			};
		}
	}
	return ml(r, a);
}, Ll = function(e, t, n) {
	var r = e.labels, i = Es, a, o, s;
	for (a in r) o = r[a] - t, o < 0 == !!n && o && i > (o = Math.abs(o)) && (s = a, i = o);
	return s;
}, Rl = function(e, t, n) {
	var r = e.vars, i = r[t], a = Ts, o = e._ctx, s, c, l;
	if (i) return s = r[t + "Params"], c = r.callbackScope || e, n && hc.length && jc(), o && (Ts = o), l = s ? i.apply(c, s) : i.call(c), Ts = a, l;
}, zl = function(e) {
	return Gc(e), e.scrollTrigger && e.scrollTrigger.kill(!!ws), e.progress() < 1 && Rl(e, "onInterrupt"), e;
}, Bl, Vl = [], Hl = function(e) {
	if (e) if (e = !e.name && e.default || e, Bs() || e.headless) {
		var t = e.name, n = Fs(e), r = t && !n && e.init ? function() {
			this._props = [];
		} : e, i = {
			init: uc,
			render: Lu,
		...
		if (eu(), e !== r) {
			if (vc[t]) return;
			Ic(r, Ic(Bc(e, i), a)), Rc(r.prototype, Rc(i, Bc(e, a))), vc[r.prop = t] = r, e.targetTest && (xc.push(r), mc[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
		}
		lc(t, r), e.register && e.register(nd, r, Hu);
	} else Vl.push(e);
}, Ul = 255, Wl = {
	aqua: [
		0,
	...
	return e += e < 0 ? 1 : e > 1 ? -1 : 0, (e * 6 < 1 ? t + (n - t) * e * 6 : e < .5 ? n : e * 3 < 2 ? t + (n - t) * (2 / 3 - e) * 6 : t) * Ul + .5 | 0;
}, Kl = function(e, t, n) {
	var r = e ? Is(e) ? [
		e >> 16,
		e >> 8 & Ul,
		e & Ul
	] : 0 : Wl.black, i, a, o, s, c, l, u, d, f, p;
	if (!r) {
		if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Wl[e]) r = Wl[e];
		else if (e.charAt(0) === "#") {
			...
			if (r = p = e.match(Ks), !t) s = r[0] % 360 / 360, c = r[1] / 100, l = r[2] / 100, a = l <= .5 ? l * (c + 1) : l + c - l * c, i = l * 2 - a, r.length > 3 && (r[3] *= 1), r[0] = Gl(s + 1 / 3, i, a), r[1] = Gl(s, i, a), r[2] = Gl(s - 1 / 3, i, a);
			else if (~e.indexOf("=")) return r = e.match(qs), n && r.length < 4 && (r[3] = 1), r;
		} else r = e.match(Ks) || Wl.transparent;
		r = r.map(Number);
	}
	return t && !p && (i = r[0] / Ul, a = r[1] / Ul, o = r[2] / Ul, u = Math.max(i, a, o), d = Math.min(i, a, o), l = (u + d) / 2, u === d ? s = c = 0 : (f = u - d, c = l > .5 ? f / (2 - u - d) : f / (u + d), s = u === i ? (a - o) / f + (a < o ? 6 : 0) : u === a ? (o - i) / f + 2 : (i - a) / f + 4, s *= 60), r[0] = ~~(s + .5), r[1] = ~~(c * 100 + .5), r[2] = ~~(l * 100 + .5)), n && r.length < 4 && (r[3] = 1), r;
}, ql = function(e) {
	var t = [], n = [], r = -1;
	return e.split(Yl).forEach(function(e) {
		var i = e.match(Js) || [];
		t.push.apply(t, i), n.push(r += i.length + 1);
	}), t.c = n, t;
}, Jl = function(e, t, n) {
	var r = "", i = (e + r).match(Yl), a = t ? "hsla(" : "rgba(", o = 0, s, c, l, u;
	if (!i) return e;
	if (i = i.map(function(e) {
		return (e = Kl(e, t, 1)) && a + (t ? e[0] + "," + e[1] + "%," + e[2] + "%," + e[3] : e.join(",")) + ")";
	}), n && (l = ql(e), s = n.c, s.join(r) !== l.c.join(r))) for (c = e.replace(Yl, "1").split(Js), u = c.length - 1; o < u; o++) r += c[o] + (~s.indexOf(o) ? i.shift() || a + "0,0,0,0)" : (l.length ? l : i.length ? i : n).shift());
	if (!c) for (c = e.split(Yl), u = c.length - 1; o < u; o++) r += c[o] + i[o];
	return r + c[u];
}, Yl = function() {
	var e = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b", t;
	for (t in Wl) e += "|" + t + "\\b";
	return RegExp(e + ")", "gi");
}(), Xl = /hsl[a]?\(/, Zl = function(e) {
	var t = e.join(" "), n;
	if (Yl.lastIndex = 0, Yl.test(t)) return n = Xl.test(t), e[1] = Jl(e[1], n), e[0] = Jl(e[0], n, ql(e[1])), !0;
}, Ql, $l = function() {
	...
	return d = {
		...
		wake: function() {
			ac && (!tc && Bs() && (ec = tc = window, nc = ec.document || {}, rc.gsap = nd, (ec.gsapVersions ||= []).push(nd.version), oc(ic || ec.GreenSockGlobals || !ec.gsap && ec || {}), Vl.forEach(Hl)), u = typeof requestAnimationFrame < "u" && requestAnimationFrame, c && d.sleep(), l = u || function(e) {
				return setTimeout(e, o - d.time * 1e3 + 1 | 0);
			}, Ql = 1, m(2));
		},
		sleep: function() {
			(u ? cancelAnimationFrame : clearTimeout)(c), Ql = 0, l = uc;
		},
		...
		add: function(e, t, n) {
			...
			return d.remove(e), s[n ? "unshift" : "push"](r), eu(), r;
		},
		remove: function(e, t) {
	...
	return !Ql && $l.wake();
}, $ = {}, tu = /^[\d.\-M][\d.\-,\s]/, nu = /["']/g, ru = function(e) {
	for (var t = {}, n = e.substr(1, e.length - 3).split(":"), r = n[0], i = 1, a = n.length, o, s, c; i < a; i++) s = n[i], o = i === a - 1 ? s.length : s.lastIndexOf(","), c = s.substr(0, o), t[r] = isNaN(c) ? c.replace(nu, "").trim() : +c, r = s.substr(o + 1).trim();
	return t;
}, iu = function(e) {
	...
	var t = (e + "").split("("), n = $[t[0]];
	return n && t.length > 1 && n.config ? n.config.apply(null, ~e.indexOf("{") ? [ru(t[1])] : iu(e).split(",").map(Pc)) : $._CE && tu.test(e) ? $._CE("", e) : n;
}, ou = function(e) {
	return function(t) {
		return 1 - e(1 - t);
	};
}, su = function(e, t) {
	return e && (Fs(e) ? e : $[e] || au(e)) || t;
}, cu = function(e, t, n, r) {
	...
	return Ec(e, function(e) {
		for (var t in $[e] = rc[e] = i, $[a = e.toLowerCase()] = n, i) $[a + (t === "easeIn" ? ".in" : t === "easeOut" ? ".out" : ".inOut")] = $[e + "." + t] = i[t];
	}), i;
}, lu = function(e) {
	return function(t) {
	...
	var i = n >= 1 ? n : 1, a = (r || (t ? .3 : .45)) / (n < 1 ? n : 1), o = a / Os * (Math.asin(1 / i) || 0), s = function(e) {
		return e === 1 ? 1 : i * 2 ** (-10 * e) * Ns((e - o) * a) + 1;
	}, c = t === "out" ? s : t === "in" ? function(e) {
		return 1 - s(1 - e);
	} : lu(s);
	return a = Os / a, c.config = function(n, r) {
		return e(t, n, r);
	}, c;
}, du = function e(t, n) {
	n === void 0 && (n = 1.70158);
...
Ec("Linear,Quad,Cubic,Quart,Quint,Strong", function(e, t) {
	var n = t < 5 ? t + 1 : t;
	cu(e + ",Power" + (n - 1), t ? function(e) {
		return e ** +n;
	} : function(e) {
		return e;
	}, function(e) {
...
}), $.Linear.easeNone = $.none = $.Linear.easeIn, cu("Elastic", uu("in"), uu("out"), uu()), (function(e, t) {
	var n = 1 / t, r = 2 * n, i = 2.5 * n, a = function(a) {
		return a < n ? e * a * a : a < r ? e * (a - 1.5 / t) ** 2 + .75 : a < i ? e * (a -= 2.25 / t) * a + .9375 : e * (a - 2.625 / t) ** 2 + .984375;
	};
	cu("Bounce", function(e) {
		return 1 - a(1 - e);
	}, a);
})(7.5625, 2.75), cu("Expo", function(e) {
	return 2 ** (10 * (e - 1)) * e + e * e * e * e * e * e * (1 - e);
}), cu("Circ", function(e) {
	return -(js(1 - e * e) - 1);
}), cu("Sine", function(e) {
	return e === 1 ? 1 : -Ms(e * ks) + 1;
}), cu("Back", du("in"), du("out"), du()), $.SteppedEase = $.steps = rc.SteppedEase = { config: function(e, t) {
	e === void 0 && (e = 1);
	var n = 1 / e, r = e + +!t, i = +!!t, a = 1 - Ds;
	return function(e) {
		return ((r * hl(0, a, e) | 0) + i) * n;
	};
} }, Ss.ease = $["quad.out"], Ec("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", function(e) {
	return Sc += e + "," + e + "Params,";
});
var fu = function(e, t) {
	this.id = As++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : Tc, this.set = t ? t.getSetter : Nu;
}, pu = /*#__PURE__*/ function() {
	function e(e) {
		this.vars = e, this._delay = +e.delay || 0, (this._repeat = e.repeat === Infinity ? -2 : e.repeat || 0) && (this._rDelay = e.repeatDelay || 0, this._yoyo = !!e.yoyo || !!e.yoyoEase), this._ts = 1, ll(this, +e.duration, 1, 1), this.data = e.data, Ts && (this._ctx = Ts, Ts.data.push(this)), Ql || $l.wake();
	}
	var t = e.prototype;
	return t.delay = function(e) {
		...
		return arguments.length ? (this._dirty = 0, ll(this, this._repeat < 0 ? e : (e - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur;
	}, t.totalTime = function(e, t) {
		if (eu(), !arguments.length) return this._tTime;
		var n = this._dp;
		if (n && n.smoothChildTiming && this._ts) {
			for (el(this, e), !n._dp || n.parent || tl(n, this); n && n.parent;) n.parent._time !== n._start + (n._ts >= 0 ? n._tTime / n._ts : (n.totalDuration() - n._tTime) / -n._ts) && n.totalTime(n._tTime, !0), n = n.parent;
			!this.parent && this._dp.autoRemoveChildren && (this._ts > 0 && e < this._tDur || this._ts < 0 && e > 0 || !this._tDur && !e) && nl(this._dp, this, this._start - this._delay);
		}
		return (this._tTime !== e || !this._dur && !t || this._initted && Math.abs(this._zTime) === Ds || !this._initted && this._dur && e || !e && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = e), Nc(this, e, t)), this;
	}, t.time = function(e, t) {
		return arguments.length ? this.totalTime(Math.min(this.totalDuration(), e + Xc(this)) % (this._dur + this._rDelay) || (e ? this._dur : 0), t) : this._time;
		...
		return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - e : e) + Xc(this), t) : this.duration() ? Math.min(1, this._time / this._dur) : +(this.rawTime() > 0);
	}, t.iteration = function(e, t) {
		var n = this.duration() + this._rDelay;
		return arguments.length ? this.totalTime(this._time + (e - 1) * n, t) : this._repeat ? Zc(this._tTime, n) + 1 : 1;
	}, t.timeScale = function(e, t) {
		if (!arguments.length) return this._rts === -Ds ? 0 : this._rts;
		if (this._rts === e) return this;
		var n = this.parent && this._ts ? Qc(this.parent._time, this) : this._tTime;
		return this._rts = +e || 0, this._ts = this._ps || e === -Ds ? 0 : this._rts, this.totalTime(hl(-Math.abs(this._delay), this.totalDuration(), n), t !== !1), $c(this), qc(this);
	}, t.paused = function(e) {
		return arguments.length ? (this._ps !== e && (this._ps = e, e ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()), this._ts = this._act = 0) : (eu(), this._ts = this._rts, this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && Math.abs(this._zTime) !== Ds && (this._tTime -= Ds)))), this) : this._ps;
	}, t.startTime = function(e) {
		if (arguments.length) {
			this._start = Oc(e);
			var t = this.parent || this._dp;
			return t && (t._sort || !this.parent) && nl(t, this, this._start - this._delay), this;
		}
		return this._start;
	}, t.endTime = function(e) {
		return this._start + (zs(e) ? this.totalDuration() : this.duration()) / Math.abs(this._ts || 1);
		...
		e === void 0 && (e = pc);
		var t = ws;
		return ws = e, Mc(this) && (this.timeline && this.timeline.revert(e), this.totalTime(-.01, e.suppressEvents)), this.data !== "nested" && e.kill !== !1 && this.kill(), ws = t, this;
	}, t.globalTime = function(e) {
		for (var t = this, n = arguments.length ? e : t.rawTime(); t;) n = t._start + n / (Math.abs(t._ts) || 1), t = t._dp;
		return !this.parent && this._sat ? this._sat.globalTime(e) : n;
	}, t.repeat = function(e) {
		return arguments.length ? (this._repeat = e === Infinity ? -2 : e, ul(this)) : this._repeat === -2 ? Infinity : this._repeat;
	}, t.repeatDelay = function(e) {
		if (arguments.length) {
			var t = this._time;
			return this._rDelay = e, ul(this), t ? this.time(t) : this;
		}
		return this._rDelay;
	}, t.yoyo = function(e) {
		return arguments.length ? (this._yoyo = e, this) : this._yoyo;
	}, t.seek = function(e, t) {
		return this.totalTime(fl(this, e), zs(t));
	}, t.restart = function(e, t) {
		return this.play().totalTime(e ? -this._delay : 0, zs(t)), this._dur || (this._zTime = -Ds), this;
	}, t.play = function(e, t) {
		...
		return arguments.length ? (!!e !== this.reversed() && this.timeScale(-this._rts || (e ? -Ds : 0)), this) : this._rts < 0;
	}, t.invalidate = function() {
		return this._initted = this._act = 0, this._zTime = -Ds, this;
	}, t.isActive = function() {
		var e = this.parent || this._dp, t = this._start, n;
		return !!(!e || this._ts && this._initted && e.isActive() && (n = e.rawTime(!0)) >= t && n < this.endTime(!0) - Ds);
		...
		return new Promise(function(r) {
			var i = Fs(e) ? e : Fc, a = function() {
				var e = t.then;
				t.then = null, n && n(), Fs(i) && (i = i(t)) && (i.then || i === t) && (t.then = e), r(i), t.then = e;
			};
...
var mu = /*#__PURE__*/ function(e) {
	...
	function t(t, n) {
		var r;
		return t === void 0 && (t = {}), r = e.call(this, t) || this, r.labels = {}, r.smoothChildTiming = !!t.smoothChildTiming, r.autoRemoveChildren = !!t.autoRemoveChildren, r._sort = zs(t.sortChildren), $s && nl(t.parent || $s, ys(r), n), t.reversed && r.reverse(), t.paused && r.paused(!0), t.scrollTrigger && rl(ys(r), t.scrollTrigger), r;
	}
	var n = t.prototype;
	return n.to = function(e, t, n) {
		return pl(0, arguments, this), this;
	}, n.from = function(e, t, n) {
		return pl(1, arguments, this), this;
	}, n.fromTo = function(e, t, n, r) {
		return pl(2, arguments, this), this;
	}, n.set = function(e, t, n) {
		return t.duration = 0, t.parent = this, Vc(t).repeatDelay || (t.repeat = 0), t.immediateRender = !!t.immediateRender, new Ou(e, t, fl(this, n), 1), this;
	}, n.call = function(e, t, n) {
		return nl(this, Ou.delayedCall(0, e, t), n);
	}, n.staggerTo = function(e, t, n, r, i, a, o) {
		return n.duration = t, n.stagger = n.stagger || r, n.onComplete = a, n.onCompleteParams = o, n.parent = this, new Ou(e, n, fl(this, i)), this;
	}, n.staggerFrom = function(e, t, n, r, i, a, o) {
		return n.runBackwards = 1, Vc(n).immediateRender = zs(n.immediateRender), this.staggerTo(e, t, n, r, i, a, o);
	}, n.staggerFromTo = function(e, t, n, r, i, a, o, s) {
		return r.startAt = n, Vc(r).immediateRender = zs(r.immediateRender), this.staggerTo(e, t, r, i, a, o, s);
	}, n.render = function(e, t, n) {
		var r = this._time, i = this._dirty ? this.totalDuration() : this._tDur, a = this._dur, o = e <= 0 ? 0 : Oc(e), s = this._zTime < 0 != e < 0 && (this._initted || !a), c, l, u, d, f, p, m, h, g, _, v, y;
		if (this !== $s && o > i && e >= 0 && (o = i), o !== this._tTime || n || s) {
			if (r !== this._time && a && (o += this._time - r, e += this._time - r), c = o, g = this._start, h = this._ts, p = !h, s && (a || (r = this._zTime), (e || !t) && (this._zTime = e)), this._repeat) {
				...
				if (c = Oc(o % f), o === i ? (d = this._repeat, c = a) : (_ = Oc(o / f), d = ~~_, d && d === _ && (c = a, d--), c > a && (c = a)), _ = Zc(this._tTime, f), !r && this._tTime && _ !== d && this._tTime - _ * f - this._dur <= 0 && (_ = d), v && d & 1 && (c = a - c, y = 1), d !== _ && !this._lock) {
					var b = v && _ & 1, x = b === (v && d & 1);
					if (d < _ && (b = !b), r = b ? 0 : o % a ? a : o, this._lock = 1, this.render(r || (y ? 0 : Oc(d * f)), t, !a)._lock = 0, this._tTime = o, !t && this.parent && Rl(this, "onRepeat"), this.vars.repeatRefresh && !y && (this.invalidate()._lock = 1, _ = d), r && r !== this._time || p !== !this._ts || this.vars.onRepeat && !this.parent && !this._act || (a = this._dur, i = this._tDur, x && (this._lock = 2, r = b ? a : -1e-4, this.render(r, !0), this.vars.repeatRefresh && !y && this.invalidate()), this._lock = 0, !this._ts && !p)) return this;
				}
			}
			if (this._hasPause && !this._forcing && this._lock < 2 && (m = cl(this, Oc(r), Oc(c)), m && (o -= c - (c = m._start))), this._tTime = o, this._time = c, this._act = !!h, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = e, r = 0), !r && o && a && !t && !_ && (Rl(this, "onStart"), this._tTime !== o)) return this;
			if (c >= r && e >= 0) for (l = this._first; l;) {
				...
				for (var S = e < 0 ? e : c; l;) {
					if (u = l._prev, (l._act || S <= l._end) && l._ts && m !== l) {
						if (l.parent !== this) return this.render(e, t, n);
						if (l.render(l._ts > 0 ? (S - l._start) * l._ts : (l._dirty ? l.totalDuration() : l._tDur) + (S - l._start) * l._ts, t, n || ws && Mc(l)), c !== this._time || !this._ts && !p) {
							m = 0, u && (o += this._zTime = S ? -Ds : Ds);
							break;
						}
					}
					l = u;
			...
			if (m && !t && (this.pause(), m.render(c >= r ? 0 : -Ds)._zTime = c >= r ? 1 : -1, this._ts)) return this._start = g, $c(this), this.render(e, t, n);
			this._onUpdate && !t && Rl(this, "onUpdate", !0), (o === i && this._tTime >= this.totalDuration() || !o && r) && (g === this._start || Math.abs(h) !== Math.abs(this._ts)) && (this._lock || ((e || !a) && (o === i && this._ts > 0 || !o && this._ts < 0) && Gc(this, 1), !t && !(e < 0 && !r) && (o || r || !i) && (Rl(this, o === i && e >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(o < i && this.timeScale() > 0) && this._prom())));
		}
		return this;
	}, n.add = function(e, t) {
		var n = this;
		if (Is(t) || (t = fl(this, t, e)), !(e instanceof pu)) {
			if (Us(e)) return e.forEach(function(e) {
				return n.add(e, t);
			}), this;
			if (Ps(e)) return this.addLabel(e, t);
			if (Fs(e)) e = Ou.delayedCall(0, e);
			else return this;
		}
		return this === e ? this : nl(this, e, t);
	}, n.getChildren = function(e, t, n, r) {
		e === void 0 && (e = !0), t === void 0 && (t = !0), n === void 0 && (n = !0), r === void 0 && (r = -Es);
		for (var i = [], a = this._first; a;) a._start >= r && (a instanceof Ou ? t && i.push(a) : (n && i.push(a), e && i.push.apply(i, a.getChildren(!0, t, n)))), a = a._next;
		return i;
	}, n.getById = function(e) {
		for (var t = this.getChildren(1, 1, 1), n = t.length; n--;) if (t[n].vars.id === e) return t[n];
	}, n.remove = function(e) {
		return Ps(e) ? this.removeLabel(e) : Fs(e) ? this.killTweensOf(e) : (e.parent === this && Wc(this, e), e === this._recent && (this._recent = this._last), Kc(this));
	}, n.totalTime = function(t, n) {
		return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = Oc($l.time - (this._ts > 0 ? t / this._ts : (this.totalDuration() - t) / -this._ts))), e.prototype.totalTime.call(this, t, n), this._forcing = 0, this) : this._tTime;
	}, n.addLabel = function(e, t) {
		return this.labels[e] = fl(this, t), this;
	}, n.removeLabel = function(e) {
		return delete this.labels[e], this;
	}, n.addPause = function(e, t, n) {
		var r = Ou.delayedCall(0, t || uc, n);
		return r.data = "isPause", this._hasPause = 1, nl(this, r, fl(this, e));
	}, n.removePause = function(e) {
		var t = this._first;
		for (e = fl(this, e); t;) t._start === e && t.data === "isPause" && Gc(t), t = t._next;
	}, n.killTweensOf = function(e, t, n) {
		for (var r = this.getTweensOf(e, n), i = r.length; i--;) yu !== r[i] && r[i].kill(e, t);
		return this;
	}, n.getTweensOf = function(e, t) {
		for (var n = [], r = xl(e), i = this._first, a = Is(t), o; i;) i instanceof Ou ? Ac(i._targets, r) && (a ? (!yu || i._initted && i._ts) && i.globalTime(0) <= t && i.globalTime(i.totalDuration()) > t : !t || i.isActive()) && n.push(i) : (o = i.getTweensOf(r, t)).length && n.push.apply(n, o), i = i._next;
		return n;
	}, n.tweenTo = function(e, t) {
		t ||= {};
		var n = this, r = fl(n, e), i = t, a = i.startAt, o = i.onStart, s = i.onStartParams, c = i.immediateRender, l, u = Ou.to(n, Ic({
			ease: t.ease || "none",
			lazy: !1,
			immediateRender: !1,
			time: r,
			overwrite: "auto",
			duration: t.duration || Math.abs((r - (a && "time" in a ? a.time : n._time)) / n.timeScale()) || Ds,
			onStart: function() {
				if (n.pause(), !l) {
					var e = t.duration || Math.abs((r - (a && "time" in a ? a.time : n._time)) / n.timeScale());
					u._dur !== e && ll(u, e, 0, 1).render(u._time, !0, !0), l = 1;
				}
				o && o.apply(u, s || []);
			}
		}, t));
		...
		return this.tweenTo(t, Ic({ startAt: { time: fl(this, e) } }, n));
	}, n.recent = function() {
		return this._recent;
	}, n.nextLabel = function(e) {
		return e === void 0 && (e = this._time), Ll(this, fl(this, e));
	}, n.previousLabel = function(e) {
		return e === void 0 && (e = this._time), Ll(this, fl(this, e), 1);
	}, n.currentLabel = function(e) {
		return arguments.length ? this.seek(e, !0) : this.previousLabel(this._time + Ds);
	}, n.shiftChildren = function(e, t, n) {
		n === void 0 && (n = 0);
		var r = this._first, i = this.labels, a;
		for (e = Oc(e); r;) r._start >= n && (r._start += e, r._end += e), r = r._next;
		...
		return this._dp && (this._time = this._tTime = this._pTime = 0), e && (this.labels = {}), Kc(this);
	}, n.totalDuration = function(e) {
		var t = 0, n = this, r = n._last, i = Es, a, o, s;
		if (arguments.length) return n.timeScale((n._repeat < 0 ? n.duration() : n.totalDuration()) / (n.reversed() ? -e : e));
		if (n._dirty) {
			for (s = n.parent; r;) a = r._prev, r._dirty && r.totalDuration(), o = r._start, o > i && n._sort && r._ts && !n._lock ? (n._lock = 1, nl(n, r, o - r._delay, 1)._lock = 0) : i = o, o < 0 && r._ts && (t -= o, (!s && !n._dp || s && s.smoothChildTiming) && (n._start += Oc(o / n._ts), n._time -= o, n._tTime -= o), n.shiftChildren(-o, !1, -Infinity), i = 0), r._end > t && r._ts && (t = r._end), r = a;
			ll(n, n === $s && n._time > t ? n._time : t, 1, 1), n._dirty = 0;
		}
		return n._tDur;
	}, t.updateRoot = function(e) {
		if ($s._ts && (Nc($s, Qc(e, $s)), _c = $l.frame), $l.frame >= bc) {
			bc += xs.autoSleep || 120;
			var t = $s._first;
			if ((!t || !t._ts) && xs.autoSleep && $l._listeners.length < 2) {
...
var hu = function(e, t, n, r, i, a, o) {
	var s = new Hu(this._pt, e, t, 0, 1, Iu, null, i), c = 0, l = 0, u, d, f, p, m, h, g, _;
	for (s.b = n, s.e = r, n += "", r += "", (g = ~r.indexOf("random(")) && (r = Pl(r)), a && (_ = [n, r], a(_, e, t), n = _[0], r = _[1]), d = n.match(Ys) || []; u = Ys.exec(r);) p = u[0], m = r.substring(c, u.index), f ? f = (f + 1) % 5 : m.substr(-5) === "rgba(" && (f = 1), p !== d[l++] && (h = parseFloat(d[l - 1]) || 0, s._pt = {
		_next: s._pt,
		p: m || l === 1 ? m : ",",
		s: h,
		c: p.charAt(1) === "=" ? kc(h, p) - h : parseFloat(p) - h,
		m: f && f < 4 ? Math.round : 0
	}, c = Ys.lastIndex);
	return s.c = c < r.length ? r.substring(c, r.length) : "", s.fp = o, (Xs.test(r) || g) && (s.e = 0), this._pt = s, s;
}, gu = function(e, t, n, r, i, a, o, s, c, l) {
	Fs(r) && (r = r(i || 0, e, a));
	var u = e[t], d = n === "get" ? Fs(u) ? c ? e[t.indexOf("set") || !Fs(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : u : n, f = Fs(u) ? c ? ju : Au : ku, p;
	if (Ps(r) && (~r.indexOf("random(") && (r = Pl(r)), r.charAt(1) === "=" && (p = kc(d, r) + (gl(d) || 0), (p || p === 0) && (r = p))), !l || d !== r || bu) return !isNaN(d * r) && r !== "" ? (p = new Hu(this._pt, e, t, +d || 0, r - (d || 0), typeof u == "boolean" ? Fu : Pu, 0, f), c && (p.fp = c), o && p.modifier(o, this, e), this._pt = p) : (!u && !(t in e) && sc(t, r), hu.call(this, e, t, d, r, f, s || xs.stringFilter, c));
}, _u = function(e, t, n, r, i) {
	if (Fs(e) && (e = Tu(e, i, t, n, r)), !Rs(e) || e.style && e.nodeType || Us(e) || Hs(e)) return Ps(e) ? Tu(e, i, t, n, r) : e;
	var a = {}, o;
	for (o in e) a[o] = Tu(e[o], i, t, n, r);
	return a;
}, vu = function(e, t, n, r, i, a) {
	var o, s, c, l;
	if (vc[e] && (o = new vc[e]()).init(i, o.rawVars ? t[e] : _u(t[e], r, i, a, n), n, r, a) !== !1 && (n._pt = s = new Hu(n._pt, i, e, 0, 1, o.render, o, 0, o.priority), n !== Bl)) for (c = n._ptLookup[n._targets.indexOf(i)], l = o._props.length; l--;) c[o._props[l]] = s;
	return o;
}, yu, bu, xu = function e(t, n, r) {
	var i = t.vars, a = i.ease, o = i.startAt, s = i.immediateRender, c = i.lazy, l = i.onUpdate, u = i.runBackwards, d = i.yoyoEase, f = i.keyframes, p = i.autoRevert, m = t._dur, h = t._startAt, g = t._targets, _ = t.parent, v = _ && _.data === "nested" ? _.vars.targets : g, y = t._overwrite === "auto" && !Cs, b = t.timeline, x = i.easeReverse || d, S, C, w, T, E, D, O, k, A, j, M, N, P;
	if (b && (!f || !a) && (a = "none"), t._ease = su(a, Ss.ease), t._rEase = x && (su(x) || t._ease), t._from = !b && !!i.runBackwards, t._from && (t.ratio = 1), !b || f && !i.stagger) {
		if (k = g[0] ? wc(g[0]).harness : 0, N = k && i[k.prop], S = Bc(i, mc), h && (h._zTime < 0 && h.progress(1), n < 0 && u && s && !p ? h.render(-1, !0) : h.revert(u && m ? fc : dc), h._lazy = 0), o) {
			if (Gc(t._startAt = Ou.set(g, Ic({
				data: "isStart",
				overwrite: !1,
				parent: _,
				immediateRender: !0,
				...
				delay: 0,
				onUpdate: l && function() {
					return Rl(t, "onUpdate");
				},
				stagger: 0
			}, o))), t._startAt._dp = 0, t._startAt._sat = t, n < 0 && (ws || !s && !p) && t._startAt.revert(fc), s && m && n <= 0 && r <= 0) {
				n && (t._zTime = n);
				return;
			}
		} else if (u && m && !h) {
			if (n && (s = !1), w = Ic({
				...
				stagger: 0,
				parent: _
			}, S), N && (w[k.prop] = N), Gc(t._startAt = Ou.set(g, w)), t._startAt._dp = 0, t._startAt._sat = t, n < 0 && (ws ? t._startAt.revert(fc) : t._startAt.render(-1, !0)), t._zTime = n, !s) e(t._startAt, Ds, Ds);
			else if (!n) return;
		}
		for (t._pt = t._ptCache = 0, c = m && zs(c) || c && !m, C = 0; C < g.length; C++) {
			if (E = g[C], O = E._gsap || Cc(g)[C]._gsap, t._ptLookup[C] = j = {}, gc[O.id] && hc.length && jc(), M = v === g ? C : v.indexOf(E), k && (A = new k()).init(E, N || S, t, M, v) !== !1 && (t._pt = T = new Hu(t._pt, E, A.name, 0, 1, A.render, A, 0, A.priority), A._props.forEach(function(e) {
				j[e] = T;
			}), A.priority && (D = 1)), !k || N) for (w in S) vc[w] && (A = vu(w, S, t, M, E, v)) ? A.priority && (D = 1) : j[w] = T = gu.call(t, E, w, "get", S[w], M, v, 0, i.stringFilter);
			t._op && t._op[C] && t.kill(E, t._op[C]), y && t._pt && (yu = t, $s.killTweensOf(E, j, t.globalTime(n)), P = !t.parent, yu = 0), t._pt && c && (gc[O.id] = 1);
		}
		D && Vu(t), t._onInit && t._onInit(t);
	}
	t._onUpdate = l, t._initted = (!t._op || t._pt) && !P, f && n <= 0 && b.render(Es, !0, !0);
}, Su = function(e, t, n, r, i, a, o, s) {
	...
	if (!c) for (c = e._ptCache[t] = [], d = e._ptLookup, f = e._targets.length; f--;) {
		...
		if (!l) return bu = 1, e.vars[t] = "+=0", xu(e, o), bu = 0, s ? cc(t + " not eligible for reset. Try splitting into individual properties") : 1;
		c.push(l);
	}
	for (f = c.length; f--;) u = c[f], l = u._pt || u, l.s = (r || r === 0) && !i ? r : l.s + (r || 0) + a * l.c, l.c = n - l.s, u.e &&= Dc(n) + gl(u.e), u.b &&= l.s + gl(u.b);
}, Cu = function(e, t) {
	var n = e[0] ? wc(e[0]).harness : 0, r = n && n.aliases, i, a, o, s;
	if (!r) return t;
	for (a in i = Rc({}, t), r) if (a in i) for (s = r[a].split(","), o = s.length; o--;) i[s[o]] = i[a];
	return i;
}, wu = function(e, t, n, r) {
	var i = t.ease || r || "power1.inOut", a, o;
	if (Us(t)) o = n[e] || (n[e] = []), t.forEach(function(e, n) {
		return o.push({
			t: n / (t.length - 1) * 100,
			v: e,
			e: i
	...
	return Fs(e) ? e.call(t, n, r, i) : Ps(e) && ~e.indexOf("random(") ? Pl(e) : e;
}, Eu = Sc + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", Du = {};
Ec(Eu + ",id,stagger,delay,duration,paused,scrollTrigger", function(e) {
	return Du[e] = 1;
});
var Ou = /*#__PURE__*/ function(e) {
	...
	function t(t, n, r, i) {
		var a;
		typeof n == "number" && (r.duration = n, n = r, r = null), a = e.call(this, i ? n : Vc(n)) || this;
		var o = a.vars, s = o.duration, c = o.delay, l = o.immediateRender, u = o.stagger, d = o.overwrite, f = o.keyframes, p = o.defaults, m = o.scrollTrigger, h = n.parent || $s, g = (Us(t) || Hs(t) ? Is(t[0]) : "length" in n) ? [t] : xl(t), _, v, y, b, x, S, C, w;
		if (a._targets = g.length ? Cc(g) : cc("GSAP target " + t + " not found. https://gsap.com", !xs.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = d, f || u || Vs(s) || Vs(c)) {
			n = a.vars;
			var T = n.easeReverse || n.yoyoEase;
			if (_ = a.timeline = new mu({
				data: "nested",
				defaults: p || {},
				targets: h && h.data === "nested" ? h.vars.targets : g
			}), _.kill(), _.parent = _._dp = ys(a), _._start = 0, u || Vs(s) || Vs(c)) {
				if (b = g.length, C = u && wl(u), Rs(u)) for (x in u) ~Eu.indexOf(x) && (w ||= {}, w[x] = u[x]);
				for (v = 0; v < b; v++) y = Bc(n, Du), y.stagger = 0, T && (y.easeReverse = T), w && Rc(y, w), S = g[v], y.duration = +Tu(s, ys(a), v, S, g), y.delay = (+Tu(c, ys(a), v, S, g) || 0) - a._delay, !u && b === 1 && y.delay && (a._delay = c = y.delay, a._start += c, y.delay = 0), _.to(S, y, C ? C(v, S, g) : 0), _._ease = $.none;
				_.duration() ? s = c = 0 : a.timeline = 0;
			} else if (f) {
				Vc(Ic(_.vars.defaults, { ease: "none" })), _._ease = su(f.ease || n.ease || "none");
				var E = 0, D, O, k;
				if (Us(f)) f.forEach(function(e) {
					return _.to(g, e, ">");
				}), _.duration();
				else {
					for (x in y = {}, f) x === "ease" || x === "easeEach" || wu(x, f[x], y, f.easeEach);
		...
		return d === !0 && !Cs && (yu = ys(a), $s.killTweensOf(g), yu = 0), nl(h, ys(a), r), n.reversed && a.reverse(), n.paused && a.paused(!0), (l || !s && !f && a._start === Oc(h._time) && zs(l) && Yc(ys(a)) && h.data !== "nested") && (a._tTime = -Ds, a.render(Math.max(0, -c) || 0)), m && rl(ys(a), m), a;
	}
	var n = t.prototype;
	return n.render = function(e, t, n) {
		var r = this._time, i = this._tDur, a = this._dur, o = e < 0, s = e > i - Ds && !o ? i : e < Ds ? 0 : e, c, l, u, d, f, p, m, h;
		if (!a) sl(this, e, t, n);
			...
			if (c = s, h = this.timeline, this._repeat) {
				...
				if (c = Oc(s % d), s === i ? (u = this._repeat, c = a) : (f = Oc(s / d), u = ~~f, u && u === f ? (c = a, u--) : c > a && (c = a)), p = this._yoyo && u & 1, p && (c = a - c), f = Zc(this._tTime, d), c === r && !n && this._initted && u === f) return this._tTime = s, this;
				u !== f && this.vars.repeatRefresh && !p && !this._lock && c !== d && this._initted && (this._lock = n = 1, this.render(Oc(d * u), !0).invalidate()._lock = 0);
			}
			if (!this._initted) {
				if (il(this, o ? e : c, n, t, s)) return this._tTime = 0, this;
			...
			if (this._from && (this.ratio = m = 1 - m), this._tTime = s, this._time = c, !this._act && this._ts && (this._act = 1, this._lazy = 0), !r && s && !t && !f && (Rl(this, "onStart"), this._tTime !== s)) return this;
			for (l = this._pt; l;) l.r(m, l.d), l = l._next;
			h && h.render(e < 0 ? e : h._dur * h._ease(c / this._dur), t, n) || this._startAt && (this._zTime = e), this._onUpdate && !t && (o && Jc(this, e, t, n), Rl(this, "onUpdate")), this._repeat && u !== f && this.vars.onRepeat && !t && this.parent && Rl(this, "onRepeat"), (s === this._tDur || !s) && this._tTime === s && (o && !this._onUpdate && Jc(this, e, !0, !0), (e || !a) && (s === this._tDur && this._ts > 0 || !s && this._ts < 0) && Gc(this, 1), !t && !(o && !r) && (s || r || p) && (Rl(this, s === i ? "onComplete" : "onReverseComplete", !0), this._prom && !(s < i && this.timeScale() > 0) && this._prom()));
		}
		return this;
	}, n.targets = function() {
		...
		Ql || $l.wake(), this._ts || this.play();
		var a = Math.min(this._dur, (this._dp._time - this._start) * this._ts), o;
		return this._initted || xu(this, a), o = this._ease(a / this._dur), Su(this, e, t, n, r, o, a, i) ? this.resetTo(e, t, n, r, 1) : (el(this, 0), this.parent || Uc(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
	}, n.kill = function(e, t) {
		if (t === void 0 && (t = "all"), !e && (!t || t === "all")) return this._lazy = this._pt = 0, this.parent ? zl(this) : this.scrollTrigger && this.scrollTrigger.kill(!!ws), this;
		if (this.timeline) {
			var n = this.timeline.totalDuration();
			return this.timeline.killTweensOf(e, t, yu && yu.vars.overwrite !== !0)._first || zl(this), this.parent && n !== this.timeline.totalDuration() && ll(this, this._dur * this.timeline._tDur / n, 0, 1), this;
		}
		var r = this._targets, i = e ? xl(e) : r, a = this._ptLookup, o = this._pt, s, c, l, u, d, f, p;
		if ((!t || t === "all") && Hc(r, i)) return t === "all" && (this._pt = 0), zl(this);
		for (s = this._op = this._op || [], t !== "all" && (Ps(t) && (d = {}, Ec(t, function(e) {
			return d[e] = 1;
		}), t = d), t = Cu(r, t)), p = r.length; p--;) if (~i.indexOf(r[p])) for (d in c = a[p], t === "all" ? (s[p] = t, u = c, l = {}) : (l = s[p] = s[p] || {}, u = t), u) f = c && c[d], f && ((!("kill" in f.d) || f.d.kill(d) === !0) && Wc(this, f, "_pt"), delete c[d]), l !== "all" && (l[d] = 1);
		return this._initted && !this._pt && o && zl(this), this;
	}, t.to = function(e, n) {
		return new t(e, n, arguments[2]);
	}, t.from = function(e, t) {
		return pl(1, arguments);
...
Ic(Ou.prototype, {
	...
	_op: 0,
	_onInit: 0
}), Ec("staggerTo,staggerFrom,staggerFromTo", function(e) {
	Ou[e] = function() {
		var t = new mu(), n = vl.call(arguments, 0);
...
var ku = function(e, t, n) {
	...
	return Fs(e[t]) ? Au : Ls(e[t]) && e.setAttribute ? Mu : ku;
}, Pu = function(e, t) {
	...
	for (var t = this._pt, n, r; t;) r = t._next, t.p === e && !t.op || t.op === e ? Wc(this, t, "_pt") : t.dep || (n = 1), t = r;
	return !n;
}, Bu = function(e, t, n, r) {
	...
	function e(e, t, n, r, i, a, o, s, c) {
		this.t = t, this.s = r, this.c = i, this.p = n, this.r = a || Pu, this.d = o || this, this.set = s || ku, this.pr = c || 0, this._next = e, e && (e._prev = this);
	}
	var t = e.prototype;
	return t.modifier = function(e, t, n) {
		this.mSet = this.mSet || this.set, this.set = Bu, this.m = e, this.mt = n, this.tween = t;
	}, e;
}();
Ec(Sc + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse", function(e) {
	return mc[e] = 1;
}), rc.TweenMax = rc.TweenLite = Ou, rc.TimelineLite = rc.TimelineMax = mu, $s = new mu({
	sortChildren: !1,
	defaults: Ss,
...
var Uu = [], Wu = {}, Gu = [], Ku = 0, qu = 0, Ju = function(e) {
	return (Wu[e] || Gu).map(function(e) {
		return e();
	});
}, Yu = function() {
	var e = Date.now(), t = [];
	e - Ku > 2 && (Ju("matchMediaInit"), Uu.forEach(function(e) {
		var n = e.queries, r = e.conditions, i, a, o, s;
		for (a in n) i = ec.matchMedia(n[a]).matches, i && (o = 1), i !== r[a] && (r[a] = i, s = 1);
		s && (e.revert(), o && t.push(e));
	}), Ju("matchMediaRevert"), t.forEach(function(e) {
	...
	function e(e, t) {
		this.selector = t && Sl(t), this.data = [], this._r = [], this.isReverted = !1, this.id = qu++, e && this.add(e);
	}
	var t = e.prototype;
	return t.add = function(e, t, n) {
		Fs(e) && (n = t, t = e, e = Fs);
		var r = this, i = function() {
			var e = Ts, i = r.selector, a;
			return e && e !== r && e.data.push(r), n && (r.selector = Sl(n)), Ts = r, a = t.apply(r, arguments), Fs(a) && r._r.push(a), Ts = e, r.selector = i, r.isReverted = !1, a;
		};
		return r.last = i, e === Fs ? i(r, function(e) {
			return r.add(null, e);
		}) : e ? r[e] = i : i;
	}, t.ignore = function(e) {
		var t = Ts;
		...
		return this.data.forEach(function(n) {
			return n instanceof e ? t.push.apply(t, n.getTweens()) : n instanceof Ou && !(n.parent && n.parent.data === "nested") && t.push(n);
		}), t;
	}, t.clear = function() {
		...
		if (e ? (function() {
			...
			for (t.map(function(e) {
				...
				return t.t.revert(e);
			}), r = n.data.length; r--;) i = n.data[r], i instanceof mu ? i.data !== "nested" && (i.scrollTrigger && i.scrollTrigger.revert(), i.kill()) : !(i instanceof Ou) && i.revert && i.revert(e);
			n._r.forEach(function(t) {
				return t(e, n);
			}), n.isReverted = !0;
		})() : this.data.forEach(function(e) {
			return e.kill && e.kill();
		}), this.clear(), t) for (var r = Uu.length; r--;) Uu[r].id === this.id && Uu.splice(r, 1);
	}, t.revert = function(e) {
		this.kill(e || {});
	}, e;
}(), Zu = /*#__PURE__*/ function() {
	function e(e) {
		this.contexts = [], this.scope = e, Ts && Ts.data.push(this);
	}
	var t = e.prototype;
	return t.add = function(e, t, n) {
		Rs(e) || (e = { matches: e });
		var r = new Xu(0, n || this.scope), i = r.conditions = {}, a, o, s;
		for (o in Ts && !r.selector && (r.selector = Ts.selector), this.contexts.push(r), t = r.add("onMatch", t), r.queries = e, e) o === "all" ? s = 1 : (a = ec.matchMedia(e[o]), a && (Uu.indexOf(r) < 0 && Uu.push(r), (i[o] = a.matches) && (s = 1), a.addListener ? a.addListener(Yu) : a.addEventListener("change", Yu)));
	...
	getProperty: function(e, t, n, r) {
		Ps(e) && (e = xl(e)[0]);
		var i = wc(e || {}).get, a = n ? Fc : Pc;
		return n === "native" && (n = ""), e && (t ? a((vc[t] && vc[t].get || i)(e, t, n, r)) : function(t, n, r) {
			return a((vc[t] && vc[t].get || i)(e, t, n, r));
		});
	},
	quickSetter: function(e, t, n) {
		if (e = xl(e), e.length > 1) {
			var r = e.map(function(e) {
				return nd.quickSetter(e, t, n);
			}), i = r.length;
			return function(e) {
				for (var t = i; t--;) r[t](e);
			};
		...
		e = e[0] || {};
		var a = vc[t], o = wc(e), s = o.harness && (o.harness.aliases || {})[t] || t, c = a ? function(t) {
			var r = new a();
			Bl._pt = 0, r.init(e, n ? t + n : t, Bl, 0, [e]), r.render(1, r), Bl._pt && Lu(1, Bl);
		} : o.set(e, s);
	...
	quickTo: function(e, t, n) {
		var r, i = nd.to(e, Ic((r = {}, r[t] = "+=0.1", r.paused = !0, r.stagger = 0, r), n || {})), a = function(e, n, r) {
	...
	defaults: function(e) {
		return e && e.ease && (e.ease = su(e.ease, Ss.ease)), zc(Ss, e || {});
	},
	config: function(e) {
		return zc(xs, e || {});
	},
	registerEffect: function(e) {
		...
		(r || "").split(",").forEach(function(e) {
			return e && !vc[e] && !rc[e] && cc(t + " effect requires " + e + " plugin.");
		}), yc[t] = function(e, t, r) {
			return n(xl(e), Ic(t || {}, i), r);
		}, a && (mu.prototype[t] = function(e, n, r) {
			return this.add(yc[t](e, Rs(n) ? n : (r = n) && {}, this), r);
		});
	},
	...
	parseEase: function(e, t) {
		return arguments.length ? su(e, t) : $;
	},
	getById: function(e) {
		return $s.getById(e);
	},
	exportRoot: function(e, t) {
		e === void 0 && (e = {});
		var n = new mu(e), r, i;
		for (n.smoothChildTiming = zs(e.smoothChildTiming), $s.remove(n), n._dp = 0, n._time = n._tTime = $s._time, r = $s._first; r;) i = r._next, (t || !(!r._dur && r instanceof Ou && r.vars.onComplete === r._targets[0])) && nl(n, r, r._start - r._delay), r = i;
		return nl($s, n, 0), n;
	},
	context: function(e, t) {
		return e ? new Xu(e, t) : Ts;
	},
	...
	core: {
		...
		context: function(e) {
			return e && Ts && (Ts.data.push(e), e._ctx = Ts), Ts;
		},
...
Ec("to,from,fromTo,delayedCall,set,killTweensOf", function(e) {
	return Qu[e] = Ou[e];
}), $l.add(mu.updateRoot), Bl = Qu.to({}, { duration: 0 });
var $u = function(e, t) {
	for (var n = e._pt; n && n.p !== t && n.op !== t && n.fp !== t;) n = n._next;
	return n;
}, ed = function(e, t) {
	var n = e._targets, r, i, a;
	for (r in t) for (i = n.length; i--;) a = e._ptLookup[i][r], (a &&= a.d) && (a._pt && (a = $u(a, r)), a && a.modifier && a.modifier(t[r], e, n[i], r));
}, td = function(e, t) {
	return {
		name: e,
		headless: 1,
	...
	render: function(e, t) {
		for (var n = t._pt; n;) ws ? n.set(n.t, n.p, n.b, n) : n.r(e, n.d), n = n._next;
	}
}, {
	name: "endArray",
	headless: 1,
...
}, td("roundProps", Tl), td("modifiers"), td("snap", El)) || Qu;
Ou.version = mu.version = nd.version = "3.15.0", ac = 1, Bs() && eu(), $.Power0, $.Power1, $.Power2, $.Power3, $.Power4, $.Linear, $.Quad, $.Cubic, $.Quart, $.Quint, $.Strong, $.Elastic, $.Back, $.SteppedEase, $.Bounce, $.Sine, $.Expo, $.Circ;
//#endregion
//#region node_modules/gsap/CSSPlugin.js
var rd, id, ad, od, sd, cd, ld, ud = function() {
	return typeof window < "u";
}, dd = {}, fd = 180 / Math.PI, pd = Math.PI / 180, md = Math.atan2, hd = 1e8, gd = /([A-Z])/g, _d = /(left|right|width|margin|padding|x)/i, vd = /[\s,\(]\S/, yd = {
...
}, Nd = "transform", Pd = Nd + "Origin", Fd = function e(t, n) {
	var r = this, i = this.target, a = i.style, o = i._gsap;
	if (t in dd && a) {
		if (this.tfm = this.tfm || {}, t !== "transform") t = yd[t] || t, ~t.indexOf(",") ? t.split(",").forEach(function(e) {
			return r.tfm[e] = ef(i, e);
		}) : this.tfm[t] = o.x ? o[t] : ef(i, t), t === Pd && (this.tfm.zOrigin = o.zOrigin);
		else return yd.transform.split(",").forEach(function(t) {
			return e.call(r, t, n);
		});
		if (this.props.indexOf(Nd) >= 0) return;
		o.svg && (this.svgo = i.getAttribute("data-svg-origin"), this.props.push(Pd, n, "")), t = Nd;
	}
	...
	for (i = 0; i < e.length; i += 3) e[i + 1] ? e[i + 1] === 2 ? t[e[i]](e[i + 2]) : t[e[i]] = e[i + 2] : e[i + 2] ? n[e[i]] = e[i + 2] : n.removeProperty(e[i].substr(0, 2) === "--" ? e[i] : e[i].replace(gd, "-$1").toLowerCase());
	if (this.tfm) {
		for (a in this.tfm) r[a] = this.tfm[a];
		r.svg && (r.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), i = ld(), (!i || !i.isStart) && !n[Nd] && (Id(n), r.zOrigin && n[Pd] && (n[Pd] += " " + r.zOrigin + "px", r.zOrigin = 0, r.renderTransform()), r.uncache = 1);
	}
}, Rd = function(e, t) {
	var n = {
		target: e,
	...
	return e._gsap || nd.core.getCache(e), t && e.style && e.nodeType && t.split(",").forEach(function(e) {
		return n.save(e);
	}), n;
}, zd, Bd = function(e, t) {
	var n = id.createElementNS ? id.createElementNS((t || "http://www.w3.org/1999/xhtml").replace(/^https/, "http"), e) : id.createElement(e);
	return n && n.style ? n : id.createElement(e);
}, Vd = function e(t, n, r) {
	var i = getComputedStyle(t);
	return i[n] || i.getPropertyValue(n.replace(gd, "-$1").toLowerCase()) || i.getPropertyValue(n) || !r && e(t, Ud(n) || n, 1) || "";
}, Hd = "O,Moz,ms,Ms,Webkit".split(","), Ud = function(e, t, n) {
	var r = (t || sd).style, i = 5;
	if (e in r && !n) return e;
	for (e = e.charAt(0).toUpperCase() + e.substr(1); i-- && !(Hd[i] + e in r););
	return i < 0 ? null : (i === 3 ? "ms" : i >= 0 ? Hd[i] : "") + e;
}, Wd = function() {
	ud() && window.document && (rd = window, id = rd.document, ad = id.documentElement, sd = Bd("div") || { style: {} }, Bd("div"), Nd = Ud(Nd), Pd = Nd + "Origin", sd.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", zd = !!Ud("perspective"), ld = nd.core.reverting, od = 1);
}, Gd = function(e) {
	var t = e.ownerSVGElement, n = Bd("svg", t && t.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), r = e.cloneNode(!0), i;
	r.style.display = "block", n.appendChild(r), ad.appendChild(n);
	try {
		i = r.getBBox();
	} catch {}
	return n.removeChild(r), ad.removeChild(n), i;
}, Kd = function(e, t) {
	...
	return t && (t.width || t.height) || n || (t = Gd(e)), t && !t.width && !t.x && !t.y ? {
		x: +Kd(e, [
			"x",
			"cx",
			"x1"
	...
	return !!(e.getCTM && (!e.parentNode || e.ownerSVGElement) && qd(e));
}, Yd = function(e, t) {
	if (t) {
		var n = e.style, r;
		t in dd && t !== Pd && (t = Nd), n.removeProperty ? (r = t.substr(0, 2), (r === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), n.removeProperty(r === "--" ? t : t.replace(gd, "-$1").toLowerCase())) : n.removeAttribute(t);
	}
}, Xd = function(e, t, n, r, i, a) {
	var o = new Hu(e._pt, t, n, 0, 1, a ? Ed : Td);
	...
	var a = parseFloat(r) || 0, o = (r + "").trim().substr((a + "").length) || "px", s = sd.style, c = _d.test(n), l = t.tagName.toLowerCase() === "svg", u = (l ? "client" : "offset") + (c ? "Width" : "Height"), d = 100, f = i === "px", p = i === "%", m, h, g, _;
	if (i === o || !a || Zd[i] || Zd[o]) return a;
	if (o !== "px" && !f && (a = e(t, n, r, "px")), _ = t.getCTM && Jd(t), (p || o === "%") && (dd[n] || ~n.indexOf("adius"))) return m = _ ? t.getBBox()[c ? "width" : "height"] : t[u], Dc(p ? a / m * d : a / 100 * m);
	if (s[c ? "width" : "height"] = d + (f ? o : i), h = i !== "rem" && ~n.indexOf("adius") || i === "em" && t.appendChild && !l ? t : t.parentNode, _ && (h = (t.ownerSVGElement || {}).parentNode), (!h || h === id || !h.appendChild) && (h = id.body), g = h._gsap, g && p && g.width && c && g.time === $l.time && !g.uncache) return Dc(a / g.width * d);
	if (p && (n === "height" || n === "width")) {
		var v = t.style[n];
		t.style[n] = d + i, m = t[u], v ? t.style[n] = v : Yd(t, n);
	} else (p || o === "%") && !Qd[Vd(h, "display")] && (s.position = Vd(t, "position")), h === t && (s.position = "static"), h.appendChild(sd), m = sd[u], h.removeChild(sd), s.position = "absolute";
	return c && p && (g = wc(h), g.time = $l.time, g.width = h[u]), Dc(f ? m * a / d : m && a ? d / m * a : 0);
}, ef = function(e, t, n, r) {
	var i;
	return od || Wd(), t in yd && t !== "transform" && (t = yd[t], ~t.indexOf(",") && (t = t.split(",")[0])), dd[t] && t !== "transform" ? (i = pf(e, r), i = t === "transformOrigin" ? i.svg ? i.origin : mf(Vd(e, Pd)) + " " + i.zOrigin + "px" : i[t]) : (i = e.style[t], (!i || i === "auto" || r || ~(i + "").indexOf("calc(")) && (i = of[t] && of[t](e, t, n) || Vd(e, t) || Tc(e, t) || +(t === "opacity"))), n && !~(i + "").trim().indexOf(" ") ? $d(e, t, i, n) + n : i;
}, tf = function(e, t, n, r) {
	if (!n || n === "none") {
		var i = Ud(t, e, 1), a = i && Vd(e, i, 1);
		a && a !== n ? (t = i, n = a) : t === "borderColor" && (n = Vd(e, "borderTopColor"));
	}
	var o = new Hu(this._pt, e.style, t, 0, 1, Iu), s = 0, c = 0, l, u, d, f, p, m, h, g, _, v, y, b;
	if (o.b = n, o.e = r, n += "", r += "", r.substring(0, 6) === "var(--" && (r = Vd(e, r.substring(4, r.indexOf(")")))), r === "auto" && (m = e.style[t], e.style[t] = r, r = Vd(e, t) || r, m ? e.style[t] = m : Yd(e, t)), l = [n, r], Zl(l), n = l[0], r = l[1], d = n.match(Js) || [], b = r.match(Js) || [], b.length) {
		for (; u = Js.exec(r);) h = u[0], _ = r.substring(s, u.index), p ? p = (p + 1) % 5 : (_.substr(-5) === "rgba(" || _.substr(-5) === "hsla(") && (p = 1), h !== (m = d[c++] || "") && (f = parseFloat(m) || 0, y = m.substr((f + "").length), h.charAt(1) === "=" && (h = kc(f, h) + y), g = parseFloat(h), v = h.substr((g + "").length), s = Js.lastIndex - v.length, v || (v = v || xs.units[t] || y, s === r.length && (r += v, o.e += v)), y !== v && (f = $d(e, t, m, v) || 0), o._pt = {
			_next: o._pt,
			p: _ || c === 1 ? _ : ",",
			s: f,
			c: g - f,
	...
	} else o.r = t === "display" && r === "none" ? Ed : Td;
	return Xs.test(r) && (o.e = 0), this._pt = o, o;
}, nf = {
	top: "0%",
	bottom: "100%",
	left: "0%",
	...
	return (n === "top" || n === "bottom" || r === "left" || r === "right") && (e = n, n = r, r = e), t[0] = nf[n] || n, t[1] = nf[r] || r, t.join(" ");
}, af = function(e, t) {
	if (t.tween && t.tween._time === t.tween._dur) {
		var n = t.t, r = n.style, i = t.u, a = n._gsap, o, s, c;
		if (i === "all" || i === !0) r.cssText = "", s = 1;
		else for (i = i.split(","), c = i.length; --c > -1;) o = i[c], dd[o] && (s = 1, o = o === "transformOrigin" ? Pd : Nd), Yd(n, o);
		s && (Yd(n, Nd), a && (a.svg && n.removeAttribute("transform"), r.scale = r.rotate = r.translate = "none", pf(n, 1), a.uncache = 1, Id(r)));
	}
}, of = { clearProps: function(e, t, n, r, i) {
	if (i.data !== "isFromStart") {
		var a = e._pt = new Hu(e._pt, t, n, 0, 0, af);
	...
	var t = Vd(e, Nd);
	return lf(t) ? sf : t.substr(7).match(qs).map(Dc);
}, df = function(e, t) {
	var n = e._gsap || wc(e), r = e.style, i = uf(e), a, o, s, c;
	return n.svg && e.getAttribute("transform") ? (s = e.transform.baseVal.consolidate().matrix, i = [
		...
		s.e,
		s.f
	], i.join(",") === "1,0,0,1,0,0" ? sf : i) : (i === sf && !e.offsetParent && e !== ad && !n.svg && (s = r.display, r.display = "block", a = e.parentNode, (!a || !e.offsetParent && !e.getBoundingClientRect().width) && (c = 1, o = e.nextElementSibling, ad.appendChild(e)), i = uf(e), s ? r.display = s : Yd(e, "display"), c && (o ? a.insertBefore(e, o) : a ? a.appendChild(e) : ad.removeChild(e))), t && i.length > 6 ? [
		i[0],
		i[1],
		i[4],
		i[5],
...
}, ff = function(e, t, n, r, i, a) {
	var o = e._gsap, s = i || df(e, !0), c = o.xOrigin || 0, l = o.yOrigin || 0, u = o.xOffset || 0, d = o.yOffset || 0, f = s[0], p = s[1], m = s[2], h = s[3], g = s[4], _ = s[5], v = t.split(" "), y = parseFloat(v[0]) || 0, b = parseFloat(v[1]) || 0, x, S, C, w;
	n ? s !== sf && (S = f * h - p * m) && (C = h / S * y + b * (-m / S) + (m * _ - h * g) / S, w = y * (-p / S) + f / S * b - (f * _ - p * g) / S, y = C, b = w) : (x = qd(e), y = x.x + (~v[0].indexOf("%") ? y / 100 * x.width : y), b = x.y + (~(v[1] || v[0]).indexOf("%") ? b / 100 * x.height : b)), r || r !== !1 && o.smooth ? (g = y - c, _ = b - l, o.xOffset = u + (g * f + _ * m) - g, o.yOffset = d + (g * p + _ * h) - _) : o.xOffset = o.yOffset = 0, o.xOrigin = y, o.yOrigin = b, o.smooth = !!r, o.origin = t, o.originIsAbsolute = !!n, e.style[Pd] = "0px 0px", a && (Xd(a, o, "xOrigin", c, y), Xd(a, o, "yOrigin", l, b), Xd(a, o, "xOffset", u, o.xOffset), Xd(a, o, "yOffset", d, o.yOffset)), e.setAttribute("data-svg-origin", y + " " + b);
}, pf = function(e, t) {
	var n = e._gsap || new fu(e);
	if ("x" in n && !t && !n.uncache) return n;
	var r = e.style, i = n.scaleX < 0, a = "px", o = "deg", s = getComputedStyle(e), c = Vd(e, Pd) || "0", l = u = d = m = h = g = _ = v = y = 0, u, d, f = p = 1, p, m, h, g, _, v, y, b, x, S, C, w, T, E, D, O, k, A, j, M, N, P, F, I, ee, te, ne, L;
	return n.svg = !!(e.getCTM && Jd(e)), s.translate && ((s.translate !== "none" || s.scale !== "none" || s.rotate !== "none") && (r[Nd] = (s.translate === "none" ? "" : "translate3d(" + (s.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") ") + (s.rotate === "none" ? "" : "rotate(" + s.rotate + ") ") + (s.scale === "none" ? "" : "scale(" + s.scale.split(" ").join(",") + ") ") + (s[Nd] === "none" ? "" : s[Nd])), r.scale = r.rotate = r.translate = "none"), S = df(e, n.svg), n.svg && (n.uncache ? (N = e.getBBox(), c = n.xOrigin - N.x + "px " + (n.yOrigin - N.y) + "px", M = "") : M = !t && e.getAttribute("data-svg-origin"), ff(e, M || c, !!M || n.originIsAbsolute, n.smooth !== !1, S)), b = n.xOrigin || 0, x = n.yOrigin || 0, S !== sf && (E = S[0], D = S[1], O = S[2], k = S[3], l = A = S[4], u = j = S[5], S.length === 6 ? (f = Math.sqrt(E * E + D * D), p = Math.sqrt(k * k + O * O), m = E || D ? md(D, E) * fd : 0, _ = O || k ? md(O, k) * fd + m : 0, _ && (p *= Math.abs(Math.cos(_ * pd))), n.svg && (l -= b - (b * E + x * O), u -= x - (b * D + x * k))) : (L = S[6], te = S[7], F = S[8], I = S[9], ee = S[10], ne = S[11], l = S[12], u = S[13], d = S[14], C = md(L, ee), h = C * fd, C && (w = Math.cos(-C), T = Math.sin(-C), M = A * w + F * T, N = j * w + I * T, P = L * w + ee * T, F = A * -T + F * w, I = j * -T + I * w, ee = L * -T + ee * w, ne = te * -T + ne * w, A = M, j = N, L = P), C = md(-O, ee), g = C * fd, C && (w = Math.cos(-C), T = Math.sin(-C), M = E * w - F * T, N = D * w - I * T, P = O * w - ee * T, ne = k * T + ne * w, E = M, D = N, O = P), C = md(D, E), m = C * fd, C && (w = Math.cos(C), T = Math.sin(C), M = E * w + D * T, N = A * w + j * T, D = D * w - E * T, j = j * w - A * T, E = M, A = N), h && Math.abs(h) + Math.abs(m) > 359.9 && (h = m = 0, g = 180 - g), f = Dc(Math.sqrt(E * E + D * D + O * O)), p = Dc(Math.sqrt(j * j + L * L)), C = md(A, j), _ = Math.abs(C) > 2e-4 ? C * fd : 0, y = ne ? 1 / (ne < 0 ? -ne : ne) : 0), n.svg && (M = e.getAttribute("transform"), n.forceCSS = e.setAttribute("transform", "") || !lf(Vd(e, Nd)), M && e.setAttribute("transform", M))), Math.abs(_) > 90 && Math.abs(_) < 270 && (i ? (f *= -1, _ += m <= 0 ? 180 : -180, m += m <= 0 ? 180 : -180) : (p *= -1, _ += _ <= 0 ? 180 : -180)), t ||= n.uncache, n.x = l - ((n.xPercent = l && (!t && n.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-l) ? -50 : 0))) ? e.offsetWidth * n.xPercent / 100 : 0) + a, n.y = u - ((n.yPercent = u && (!t && n.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * n.yPercent / 100 : 0) + a, n.z = d + a, n.scaleX = Dc(f), n.scaleY = Dc(p), n.rotation = Dc(m) + o, n.rotationX = Dc(h) + o, n.rotationY = Dc(g) + o, n.skewX = _ + o, n.skewY = v + o, n.transformPerspective = y + a, (n.zOrigin = parseFloat(c.split(" ")[2]) || !t && n.zOrigin || 0) && (r[Pd] = mf(c)), n.xOffset = n.yOffset = 0, n.force3D = xs.force3D, n.renderTransform = n.svg ? xf : zd ? bf : gf, n.uncache = 0, n;
}, mf = function(e) {
	return (e = e.split(" "))[0] + " " + e[1];
}, hf = function(e, t, n) {
	var r = gl(t);
	return Dc(parseFloat(t) + parseFloat($d(e, "x", n + "px", r))) + r;
}, gf = function(e, t) {
	t.z = "0px", t.rotationY = t.rotationX = "0deg", t.force3D = 0, bf(e, t);
}, _f = "0deg", vf = "0px", yf = ") ", bf = function(e, t) {
	...
	if (v && (u !== _f || l !== _f)) {
		var x = parseFloat(l) * pd, S = Math.sin(x), C = Math.cos(x), w;
		x = parseFloat(u) * pd, w = Math.cos(x), a = hf(_, a, S * w * -v), o = hf(_, o, -Math.sin(x) * -v), s = hf(_, s, C * w * -v + v);
	}
	h !== vf && (y += "perspective(" + h + yf), (r || i) && (y += "translate(" + r + "%, " + i + "%) "), (b || a !== vf || o !== vf || s !== vf) && (y += s !== vf || b ? "translate3d(" + a + ", " + o + ", " + s + ") " : "translate(" + a + ", " + o + yf), c !== _f && (y += "rotate(" + c + yf), l !== _f && (y += "rotateY(" + l + yf), u !== _f && (y += "rotateX(" + u + yf), (d !== _f || f !== _f) && (y += "skew(" + d + ", " + f + yf), (p !== 1 || m !== 1) && (y += "scale(" + p + ", " + m + yf), _.style[Nd] = y || "translate(0, 0)";
}, xf = function(e, t) {
	...
	s = parseFloat(s), c = parseFloat(c), l = parseFloat(l), l && (l = parseFloat(l), c += l, s += l), s || c ? (s *= pd, c *= pd, b = Math.cos(s) * u, x = Math.sin(s) * u, S = Math.sin(s - c) * -d, C = Math.cos(s - c) * d, c && (l *= pd, w = Math.tan(c - l), w = Math.sqrt(1 + w * w), S *= w, C *= w, l && (w = Math.tan(l), w = Math.sqrt(1 + w * w), b *= w, x *= w)), b = Dc(b), x = Dc(x), S = Dc(S), C = Dc(C)) : (b = u, C = d, x = S = 0), (v && !~(a + "").indexOf("px") || y && !~(o + "").indexOf("px")) && (v = $d(f, "x", a, "px"), y = $d(f, "y", o, "px")), (p || m || h || g) && (v = Dc(v + p - (p * b + m * S) + h), y = Dc(y + m - (p * x + m * C) + g)), (r || i) && (w = f.getBBox(), v = Dc(v + r / 100 * w.width), y = Dc(y + i / 100 * w.height)), w = "matrix(" + b + "," + x + "," + S + "," + C + "," + v + "," + y + ")", f.setAttribute("transform", w), _ && (f.style[Nd] = w);
}, Sf = function(e, t, n, r, i) {
	var a = 360, o = Ps(i), s = parseFloat(i) * (o && ~i.indexOf("rad") ? fd : 1) - r, c = r + s + "deg", l, u;
	return o && (l = i.split("_")[1], l === "short" && (s %= a, s !== s % (a / 2) && (s += s < 0 ? a : -a)), l === "cw" && s < 0 ? s = (s + a * hd) % a - ~~(s / a) * a : l === "ccw" && s > 0 && (s = (s - a * hd) % a - ~~(s / a) * a)), e._pt = u = new Hu(e._pt, t, n, r, s, xd), u.e = c, u.u = "deg", e._props.push(n), u;
}, Cf = function(e, t) {
	for (var n in t) e[n] = t[n];
	return e;
}, wf = function(e, t, n) {
	var r = Cf({}, n._gsap), i = "perspective,force3D,transformOrigin,svgOrigin", a = n.style, o, s, c, l, u, d, f, p;
	for (s in r.svg ? (c = n.getAttribute("transform"), n.setAttribute("transform", ""), a[Nd] = t, o = pf(n, 1), Yd(n, Nd), n.setAttribute("transform", c)) : (c = getComputedStyle(n)[Nd], a[Nd] = t, o = pf(n, 1), a[Nd] = c), dd) c = r[s], l = o[s], c !== l && i.indexOf(s) < 0 && (f = gl(c), p = gl(l), u = f === p ? parseFloat(c) : $d(n, s, c, p), d = parseFloat(l), e._pt = new Hu(e._pt, o, s, u, d - u, bd), e._pt.u = p || 0, e._props.push(s));
	Cf(o, r);
};
Ec("padding,margin,Width,Radius", function(e, t) {
	...
	of[t > 1 ? "border" + e : e] = function(e, t, n, r, i) {
		var a, s;
...
var Tf = {
	...
	init: function(e, t, n, r, i) {
		...
		for (m in od || Wd(), this.styles = this.styles || Rd(e), C = this.styles.props, this.tween = n, t) if (m !== "autoRound" && (l = t[m], !(vc[m] && vu(m, t, n, r, e, i)))) {
			if (f = typeof l, p = of[m], f === "function" && (l = l.call(n, r, e, i), f = typeof l), f === "string" && ~l.indexOf("random(") && (l = Pl(l)), p) p(this, e, m, l, n) && (S = 1);
			else if (m.substr(0, 2) === "--") c = (getComputedStyle(e).getPropertyValue(m) + "").trim(), l += "", Yl.lastIndex = 0, Yl.test(c) || (h = gl(c), g = gl(l), g ? h !== g && (c = $d(e, m, c, g) + g) : h && (l += h)), this.add(o, "setProperty", c, l, r, i, 0, 0, m), a.push(m), C.push(m, 0, o[m]);
			else if (f !== "undefined") {
				if (s && m in s ? (c = typeof s[m] == "function" ? s[m].call(n, r, e, i) : s[m], Ps(c) && ~c.indexOf("random(") && (c = Pl(c)), gl(c + "") || c === "auto" || (c += xs.units[m] || gl(ef(e, m)) || ""), (c + "").charAt(1) === "=" && (c = ef(e, m))) : c = ef(e, m), d = parseFloat(c), _ = f === "string" && l.charAt(1) === "=" && l.substr(0, 2), _ && (l = l.substr(2)), u = parseFloat(l), m in yd && (m === "autoAlpha" && (d === 1 && ef(e, "visibility") === "hidden" && u && (d = 0), C.push("visibility", 0, o.visibility), Xd(this, o, "visibility", d ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), m !== "scale" && m !== "transform" && (m = yd[m], ~m.indexOf(",") && (m = m.split(",")[0]))), v = m in dd, v) {
					if (this.styles.save(m), w = l, f === "string" && l.substring(0, 6) === "var(--") {
						if (l = Vd(e, l.substring(4, l.indexOf(")"))), l.substring(0, 5) === "calc(") {
							var T = e.style.perspective;
							e.style.perspective = l, l = Vd(e, "perspective"), T ? e.style.perspective = T : Yd(e, "perspective");
						}
						u = parseFloat(l);
					}
					if (y || (b = e._gsap, b.renderTransform && !t.parseTransform || pf(e, t.parseTransform), x = t.smoothOrigin !== !1 && b.smooth, y = this._pt = new Hu(this._pt, o, Nd, 0, 1, b.renderTransform, b, 0, -1), y.dep = 1), m === "scale") this._pt = new Hu(this._pt, b, "scaleY", b.scaleY, (_ ? kc(b.scaleY, _ + u) : u) - b.scaleY || 0, bd), this._pt.u = 0, a.push("scaleY", m), m += "X";
					else if (m === "transformOrigin") {
						C.push(Pd, 0, o[Pd]), l = rf(l), b.svg ? ff(e, l, 0, x, 0, this) : (g = parseFloat(l.split(" ")[2]) || 0, g !== b.zOrigin && Xd(this, b, "zOrigin", b.zOrigin, g), Xd(this, o, m, mf(c), mf(l)));
						continue;
					} else if (m === "svgOrigin") {
						ff(e, l, 1, x, 0, this);
						continue;
					} else if (m in cf) {
						Sf(this, b, m, d, _ ? kc(d, _ + l) : l);
						continue;
					} else if (m === "smoothOrigin") {
						Xd(this, b, "smooth", b.smooth, l);
						continue;
					} else if (m === "force3D") {
						b[m] = l;
						continue;
				...
				} else m in o || (m = Ud(m) || m);
				if (v || (u || u === 0) && (d || d === 0) && !vd.test(l) && m in o) h = (c + "").substr((d + "").length), u ||= 0, g = gl(l) || (m in xs.units ? xs.units[m] : h), h !== g && (d = $d(e, m, c, g)), this._pt = new Hu(this._pt, v ? b : o, m, d, (_ ? kc(d, _ + u) : u) - d, !v && (g === "px" || m === "zIndex") && t.autoRound !== !1 ? wd : bd), this._pt.u = g || 0, v && w !== l ? (this._pt.b = c, this._pt.e = w, this._pt.r = Cd) : h !== g && g !== "%" && (this._pt.b = c, this._pt.r = Sd);
				else if (m in o) tf.call(this, e, m, c, _ ? _ + l : l);
	...
	render: function(e, t) {
		if (t.tween._time || !ld()) for (var n = t._pt; n;) n.r(e, n.d), n = n._next;
	...
	getSetter: function(e, t, n) {
		var r = yd[t];
		return r && r.indexOf(",") < 0 && (t = r), t in dd && t !== Pd && (e._gsap.x || ef(e, "x")) ? n && cd === n ? t === "scale" ? Ad : kd : (cd = n || {}) && (t === "scale" ? jd : Md) : e.style && !Ls(e.style[t]) ? Dd : ~t.indexOf("-") ? Od : Nu(e, t);
	},
	core: {
		_removeProperty: Yd,
		_getMatrix: df
...
nd.utils.checkPrefix = Ud, nd.core.getStyleSaver = Rd, (function(e, t, n, r) {
	var i = Ec(e + "," + t + "," + n, function(e) {
		dd[e] = 1;
	});
	Ec(t, function(e) {
		xs.units[e] = "deg", cf[e] = 1;
	}), yd[i[13]] = e + "," + t, Ec(r, function(e) {
		var t = e.split(":");
		yd[t[1]] = i[t[0]];
	});
})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent", "rotation,rotationX,rotationY,skewX,skewY", "transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", "0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY"), Ec("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective", function(e) {
	xs.units[e] = "px";
}), nd.registerPlugin(Tf);
//#endregion
//#region node_modules/gsap/index.js
var Ef = nd.registerPlugin(Tf) || nd;
Ef.core.Tween;
//#endregion
//#region src/presentation-ripple.ts
var Df = "\n  varying vec2 vUv;\n  void main(){ vUv=uv; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }\n", Of = "\n  uniform sampler2D uCurrent;\n  uniform sampler2D uNext;\n  uniform float uProgress;\n  uniform float uAspect;\n  varying vec2 vUv;\n  void main(){\n    vec2 p=vUv-0.5;\n    p.x*=uAspect;\n    float dist=length(p);\n    float front=uProgress*1.25;\n    float trail=dist-front;\n    float wave=sin(trail*72.0)*exp(-abs(trail)*22.0);\n    vec2 dir=normalize(p+vec2(0.0001));\n    vec2 displaced=vUv+dir*wave*0.018;\n    float blend=smoothstep(0.055,-0.025,trail);\n    vec4 color=mix(texture2D(uCurrent,displaced),texture2D(uNext,displaced),blend);\n    color.rgb+=abs(wave)*0.22;\n    gl_FragColor=color;\n  }\n", kf = [
	{
		title: "Enterprise Digital COO",
		kicker: "AI command centre",
		image: "/static/assets/animated-footer-middle.png"
	},
	{
		title: "Decisions at the speed of data",
		kicker: "Executive intelligence",
		image: "/static/assets/edcoo-logo.svg"
	},
	{
		title: "From signals to action",
		kicker: "Nine-page guided story",
		image: "/static/assets/animated-footer-middle.png"
	}
], Af = document.querySelector("[data-ripple-presentation]");
if (Af) {
	let e = Af.querySelector("canvas"), t = Af.querySelector("[data-ripple-title]"), n = Af.querySelector("[data-ripple-kicker]"), r = Af.querySelector("[data-ripple-status]");
	if (e && t && n && r) {
		let a = new vs({
			canvas: e,
			antialias: !0,
		...
		a.setPixelRatio(Math.min(devicePixelRatio || 1, 2)), a.outputColorSpace = O;
		let o = new mt(), s = new Lr(-.5, .5, .5, -.5, .01, 10);
		s.position.z = 1;
		let c = new Or();
		c.setCrossOrigin("anonymous");
		let l = kf.map((e) => {
			let t = c.load(e.image);
			return t.colorSpace = O, t.minFilter = i, t.magFilter = i, t;
		}), u = new ir({
			vertexShader: Df,
			fragmentShader: Of,
			uniforms: {
		...
		o.add(new Mn(d, u));
		let f = 0, p = !1, m = 0, h = !1, g = (e) => {
			t.innerHTML = "", Array.from(e).forEach((e) => {
				let n = document.createElement("span");
				n.className = "ripple-char-mask";
				let r = document.createElement("span");
				r.className = "ripple-char", r.textContent = e === " " ? "\xA0" : e, n.appendChild(r), t.appendChild(n);
			});
		}, _ = (e) => {
			g(kf[e].title), n.textContent = kf[e].kicker, r.textContent = `${String(e + 1).padStart(2, "0")} / ${String(kf.length).padStart(2, "0")}`, Ef.fromTo(t.querySelectorAll(".ripple-char"), { yPercent: 115 }, {
				yPercent: 0,
				duration: .7,
				stagger: .018,
				ease: "power3.out"
			...
			clearTimeout(m), h && (m = window.setTimeout(y, 4800));
		}, y = () => {
			if (p) return;
			p = !0;
			let e = (f + 1) % kf.length;
			u.uniforms.uNext.value = l[e], Ef.to([
				t,
				n,
				r
			], {
				...
				duration: .25,
				ease: "power2.in"
			}), Ef.fromTo(u.uniforms.uProgress, { value: 0 }, {
				value: 1,
				duration: 1.15,
				ease: "power2.inOut",
				onComplete: () => {
					f = e, u.uniforms.uCurrent.value = l[f], u.uniforms.uProgress.value = 0, Ef.set([
						t,
						n,
						r
					], {
			...
			let e = Af.clientWidth, t = Af.clientHeight;
			a.setSize(e, t, !1), u.uniforms.uAspect.value = e / Math.max(t, 1);
		};
		b();
		...
		let C = new IntersectionObserver(([e]) => {
			h = e.isIntersecting, h ? v() : clearTimeout(m);
		}, { threshold: .2 });
		C.observe(Af), Af.addEventListener("click", y), Af.addEventListener("keydown", (e) => {
			(e.key === "Enter" || e.key === " ") && (e.preventDefault(), y());
		}), window.addEventListener("pagehide", () => {
			clearTimeout(m), C.disconnect(), x.disconnect(), Ef.ticker.remove(S), l.forEach((e) => e.dispose()), d.dispose(), u.dispose(), a.dispose();
		}, { once: !0 });
	}
}
var jf = Array.from(document.querySelectorAll(".slide-page"));
if (jf.length) {
	let e = Array.from(document.querySelectorAll(".pager a")), t = Math.max(0, jf.findIndex((e) => `#${e.id}` === location.hash)), n = !1, r = document.createElement("nav");
	r.className = "deck-nav", r.setAttribute("aria-label", "Presentation controls"), r.innerHTML = "<button type=\"button\" data-deck-prev aria-label=\"Previous slide\">←</button><span data-deck-count></span><button type=\"button\" data-deck-next aria-label=\"Next slide\">→</button>", document.body.appendChild(r);
	let i = r.querySelector("[data-deck-count]"), a = (t) => {
		jf.forEach((e, n) => {
			let r = n === t;
			e.classList.toggle("is-active", r), e.setAttribute("aria-hidden", String(!r));
		}), e.forEach((e, n) => {
			e.classList.toggle("is-active", n === t), n === t ? e.setAttribute("aria-current", "page") : e.removeAttribute("aria-current");
		}), i.textContent = `${String(t + 1).padStart(2, "0")} / ${String(jf.length).padStart(2, "0")}`, history.replaceState(null, "", `#${jf[t].id}`);
	}, o = (e, r = 1) => {
		if (n) return;
		let i = (e + jf.length) % jf.length;
		if (i === t) return;
		n = !0;
		let o = jf[t], s = jf[i];
		s.classList.add("is-active"), s.style.zIndex = "2", s.setAttribute("aria-hidden", "false"), Ef.set(s, {
			opacity: 1,
			clipPath: `circle(0% at ${r > 0 ? "82%" : "18%"} 50%)`
		}), Ef.to(o, {
			opacity: 0,
			scale: .975,
			duration: .48,
			...
			clipPath: `circle(150% at ${r > 0 ? "82%" : "18%"} 50%)`,
			duration: .85,
			ease: "power3.inOut",
			onComplete: () => {
				o.classList.remove("is-active"), Ef.set(o, {
					opacity: 0,
					scale: 1,
					clearProps: "zIndex"
				}), s.style.zIndex = "", t = i, a(t), n = !1;
			}
		}), Ef.fromTo(s.querySelectorAll(".slide-copy > *, .shot, .stack-wrap, .ripple-stage"), {
			y: 34 * r,
			opacity: 0
		}, {
			y: 0,
	...
	a(t), r.querySelector("[data-deck-prev]")?.addEventListener("click", () => o(t - 1, -1)), r.querySelector("[data-deck-next]")?.addEventListener("click", () => o(t + 1, 1)), e.forEach((e, n) => e.addEventListener("click", (e) => {
		e.preventDefault(), o(n, n >= t ? 1 : -1);
	})), window.addEventListener("keydown", (e) => {
		(e.key === "ArrowRight" || e.key === "PageDown") && o(t + 1, 1), (e.key === "ArrowLeft" || e.key === "PageUp") && o(t - 1, -1);
	});
	let s = !1;
	window.addEventListener("wheel", (e) => {
		if (s || Math.abs(e.deltaY) < 20) return;
		s = !0;
		let n = e.deltaY > 0 ? 1 : -1;
		o(t + n, n), window.setTimeout(() => {
			s = !1;
		}, 950);
	}, { passive: !0 });
	let c = 0;
	window.addEventListener("touchstart", (e) => {
		c = e.touches[0]?.clientX || 0;
	}, { passive: !0 }), window.addEventListener("touchend", (e) => {
		let n = (e.changedTouches[0]?.clientX || 0) - c;
		Math.abs(n) > 45 && o(t + (n < 0 ? 1 : -1), n < 0 ? 1 : -1);
	}, { passive: !0 });
}
//#endregion
